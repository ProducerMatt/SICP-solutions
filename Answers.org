...
(define (length-segment seg) ; valid but not necessary
  (let ((diffP (sub-points (start-segment seg)
                           (end-segment seg))))
    (+ (abs (x-point diffP))
       (abs (y-point diffP)))))
#+end_src
...
#+RESULTS[389e901c5db2cf7eb53c0107c36f14ac071f40d8]: rect-test
#+begin_EXAMPLE
