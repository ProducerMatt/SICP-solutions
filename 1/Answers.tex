...
\label{sec:org10ca843}
\subsubsection{\texttt{try-these}}
\label{sec:orgdd79cef}
...
\label{sec:org205491c}
\subsection{Question}
\label{sec:orgbdd149f}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:orga93ad7a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:orge561da8}
\subsection{Question}
\label{sec:orga090652}
...
\label{sec:orgcf7dd5e}
\subsection{Text}
\label{sec:org90bd9e8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:org5bbab76}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:org689d9cb}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgf4e2032}
\subsection{Question}
\label{sec:org407ee49}
...
\label{sec:org749acfa}
\subsection{Question}
\label{sec:org9148164}
...
\label{sec:org3cc1a28}
\subsection{Text code}
\label{sec:orgcf2b73c}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:org840c259}
\subsection{Text}
\label{sec:orgba56e77}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:orge9a0bac}
...
\subsection{Diary}
\label{sec:orgec35b30}
\subsubsection{Solving}
\label{sec:org152e6c4}
...
\label{sec:orgb6468fb}
\begin{enumerate}
\item Non-optimized
\label{sec:org49f18e7}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:org65cfce3}
\subsection{Question}
\label{sec:org083f348}
...
\label{sec:org3258b97}
\subsection{Question}
\label{sec:org9209dca}
...
\label{sec:orge7d68c1}
\subsection{Question}
\label{sec:org1c80624}
...
\subsection{Answer}
\label{sec:orgd9c6f3e}
\subsubsection{\texttt{f}}
\label{sec:org39a2127}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<try-these>>
<<EX1-10-defs>>
...
\label{sec:org4e5ee7e}
\subsection{Question}
\label{sec:org8d2419f}
...
\subsection{Answer}
\label{sec:org028abb1}
\subsubsection{Recursive}
\label{sec:orgfdb0e40}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org07949c9}
\begin{enumerate}
\item Attempt 1
\label{sec:orgef49d3e}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org1991e87}
\subsection{Question}
\label{sec:org2a17a9e}
...
\label{sec:orgfd3a3c5}
\subsection{Question}
\label{sec:org31fb8c1}
...
\label{sec:orgb016464}
\subsection{Question 1}
\label{sec:org70c4158}
...
\label{sec:orgab180d0}
\subsection{Text}
\label{sec:org4651124}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org86316ed}
\subsection{Question}
\label{sec:org12acb75}
...
\label{sec:orgc653be3}
\subsection{Question}
\label{sec:org79d14a0}
Using the results of \hyperref[sec:orgab180d0]{Exercise 1.16} and \hyperref[sec:org86316ed]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org76f0da7}
\subsubsection{Comparison benchmarks:}
\label{sec:org229b33e}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(load "../mattbench.scm")
<<fast-mult-iter>>
<<fast-mult-rec>>
...
\label{sec:org60b8035}
\subsection{Question}
\label{sec:org5c957f2}
...
\label{sec:org7a3f44f}
\subsection{Text}
\label{sec:org6d4c66a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org7a22920}
\subsection{Text}
\label{sec:orgb8198e0}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org1a45e2b}
\subsection{Question}
\label{sec:orgeb7dfd8}
...
\subsection{Answer}
\label{sec:orgbeda6e8}
\subsubsection{Part 1}
\label{sec:org2287f27}
...
\label{sec:org572e37e}
\subsection{Question}
\label{sec:orgdbc8984}
