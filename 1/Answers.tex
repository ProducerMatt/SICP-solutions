...
\label{sec:org996ed3c}
\subsubsection*{\texttt{try-these}}
\label{sec:org4434ccb}
...
\label{sec:orgbeb5360}
\subsection{Question}
\label{sec:org33f3cbd}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:org6b8201b}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:org64f3781}
\subsection{Question}
\label{sec:org26c78bf}
...
\label{sec:org022c303}
\subsection{Text}
\label{sec:org44a24a6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:org89782df}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:org21a9768}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org5dcf35e}
\subsection{Question}
\label{sec:org3208de2}
...
\label{sec:org6428418}
\subsection{Question}
\label{sec:orgde791e6}
...
\label{sec:org694db16}
\subsection{Text code}
\label{sec:org477c3c2}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:orgc01f4b6}
\subsection{Text}
\label{sec:org8a775e3}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:org64d99da}
...
\subsection{Diary}
\label{sec:org8d5cd81}
\subsubsection{Solving}
\label{sec:org56db984}
...
\label{sec:orgdc36a5f}
\begin{enumerate}
\item Non-optimized
\label{sec:org39a56d1}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:orgf5e883b}
\subsection{Question}
\label{sec:org6cc2038}
...
\label{sec:org62e2ea8}
\subsection{Question}
\label{sec:org4771bca}
...
\label{sec:org3eafd29}
\subsection{Question}
\label{sec:orgc640709}
...
\subsection{Answer}
\label{sec:org6b58aab}
\subsubsection{\texttt{f}}
\label{sec:org5e9262b}
...
\label{sec:org665d034}
\subsection{Question}
\label{sec:orgd90d026}
...
\subsection{Answer}
\label{sec:org0637b93}
\subsubsection{Recursive}
\label{sec:orgc9efd26}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org059c630}
\begin{enumerate}
\item Attempt 1
\label{sec:org3a66941}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgfec98c4}
\subsection{Question}
\label{sec:org345cc83}
...
\label{sec:org2aee2d4}
\subsection{Question}
\label{sec:orgdeba988}
...
\label{sec:org986618b}
\subsection{Question A}
\label{sec:org365beec}
...
\label{sec:org0645282}
\subsection{Text}
\label{sec:org7a56ad9}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:orgf396dfe}
\subsection{Question}
\label{sec:orga90e4ea}
...
\label{sec:orgde70837}
\subsection{Question}
\label{sec:org8cfa8e7}
Using the results of \hyperref[sec:org0645282]{Exercise 1.16} and \hyperref[sec:orgf396dfe]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:orga824166}
\subsubsection{Comparison benchmarks:}
\label{sec:orgd56560f}
...
\label{sec:orgb7817da}
\subsection{Question}
\label{sec:org65c4e75}
...
\label{sec:org80ee51e}
\subsection{Text}
\label{sec:org52b9ded}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:orgb4259dd}
\subsection{Text}
\label{sec:org6f1c986}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org79b023c}
\subsection{Question}
\label{sec:org08a8b19}
...
\subsection{Answer}
\label{sec:org0b7910a}
\subsubsection{Part 1}
\label{sec:orgb96926b}
...
\label{sec:org8b681c7}
\subsection{Question}
\label{sec:org6a87c4a}
...
\label{sec:org80ca26c}
\subsection{Text}
\label{sec:org36f59ed}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org828a49c}
\subsection{Question}
\label{sec:org9e6428f}
...
\label{sec:org04727e1}
\subsection{Question}
\label{sec:org2ef0816}
...
\label{sec:org258cb5d}
\subsection{Question}
\label{sec:org89d803b}
...
\label{sec:org16b59dc}
\subsection{Question}
\label{sec:orgf61612f}
...
\label{sec:orgaeacc5e}
\subsection{Text}
\label{sec:orga9c5a74}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org6341c2c}
\subsection{Question}
\label{sec:org23ba072}
...
\label{sec:orgdc38905}
\subsection{Question A.1}
\label{sec:org4306268}
...
\label{sec:orgbe4c487}
\subsection{Question A}
\label{sec:orgf52fa52}
...
\label{sec:orgd0f74e0}
\subsection{Question A}
\label{sec:org33aa0e4}
\index{filter}
...
\label{sec:orgbfad46d}
\subsection{Question}
\label{sec:org6a87399}
...
\label{sec:org27c4915}
\subsection{Text}
\label{sec:orgc9c9012}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org707d492}
\subsection{Question}
\label{sec:org862077b}
...
\label{sec:org4086489}
\subsection{Question A}
\label{sec:org04697e7}
...
\label{sec:orgefefd85}
\subsection{Question}
\label{sec:org6253888}
...
\label{sec:org9df4744}
\subsection{Question}
\label{sec:org2adb9dd}
...
\label{sec:org5f0bf58}
\subsection{Text}
\label{sec:org11ca347}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org1ff0cdd}
\subsection{Question}
\label{sec:org5886392}
...
\label{sec:org0b77189}
\subsection{Question}
\label{sec:org4c6d9a5}
...
\label{sec:org3f6df27}
\subsection{Question}
\label{sec:orgfcda4e3}
