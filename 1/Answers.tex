...
\label{sec:org63b3504}
\subsubsection*{\texttt{try-these}}
\label{sec:org993970a}
...
\label{sec:orgf498991}
\subsection{Question}
\label{sec:org9270bf6}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:org991f10b}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:orgd590d5b}
\subsection{Question}
\label{sec:org5f37cd2}
...
\label{sec:org7352243}
\subsection{Text}
\label{sec:org90e5e87}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:org0708ba5}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:orgbe47575}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org1ef2a62}
\subsection{Question}
\label{sec:orge5c726b}
...
\label{sec:orgb880bfb}
\subsection{Question}
\label{sec:org5292619}
...
\label{sec:org1045a2c}
\subsection{Text code}
\label{sec:org0a592c5}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:orga7486b5}
\subsection{Text}
\label{sec:org34e5156}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:org0a427c4}
...
\subsection{Diary}
\label{sec:org556b6bc}
\subsubsection{Solving}
\label{sec:orgb2fa118}
...
\label{sec:org5a2a158}
\begin{enumerate}
\item Non-optimized
\label{sec:org9240c3e}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:org62e3725}
\subsection{Question}
\label{sec:org7b8f6a4}
...
\label{sec:org51076e1}
\subsection{Question}
\label{sec:org0d43726}
...
\label{sec:orge15c7fb}
\subsection{Question}
\label{sec:org66beff7}
...
\subsection{Answer}
\label{sec:orga94364a}
\subsubsection{\texttt{f}}
\label{sec:org14a39f7}
...
\label{sec:org94a4a74}
\subsection{Question}
\label{sec:org6a15fe5}
...
\subsection{Answer}
\label{sec:orged89d31}
\subsubsection{Recursive}
\label{sec:org21ac3a2}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:orgb994e01}
\begin{enumerate}
\item Attempt 1
\label{sec:org6a8f33b}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org3b27da8}
\subsection{Question}
\label{sec:org617684f}
...
\label{sec:orge132c13}
\subsection{Question}
\label{sec:org3fda325}
...
\label{sec:org709fe6e}
\subsection{Question 1}
\label{sec:orgfe6079a}
...
\label{sec:orgbe73989}
\subsection{Text}
\label{sec:org2d6e47e}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:orgf34547f}
\subsection{Question}
\label{sec:org2826044}
...
\label{sec:orgcc076a0}
\subsection{Question}
\label{sec:orga00af92}
Using the results of \hyperref[sec:orgbe73989]{Exercise 1.16} and \hyperref[sec:orgf34547f]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org3c19ecf}
\subsubsection{Comparison benchmarks:}
\label{sec:org561b616}
...
\label{sec:orgca0ed20}
\subsection{Text}
\label{sec:org7ef4ba5}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:orgefeaf93}
\subsection{Text}
\label{sec:org8ed040c}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org34aff6d}
\subsection{Question}
\label{sec:org10f7668}
...
\subsection{Answer}
\label{sec:orgd68bf4e}
\subsubsection{Part 1}
\label{sec:orgda5e804}
...
\label{sec:org4891788}
\subsection{Question}
\label{sec:org642f196}
...
\label{sec:org42af6ff}
\subsection{Text}
\label{sec:orgfd4d328}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgcc18eb4}
\subsection{Question}
\label{sec:orgf7413c6}
...
\label{sec:org4787f72}
\subsection{Question}
\label{sec:orgf4cc25d}
...
\label{sec:orgab85627}
\subsection{Question}
\label{sec:org1b7c616}
...
\label{sec:orgdd4a048}
\subsection{Question}
\label{sec:org208fc67}
...
\label{sec:org31e1be7}
\subsection{Text}
\label{sec:orgeb33cbd}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org8330244}
\subsection{Question}
\label{sec:orga914190}
...
\label{sec:org0b21bca}
\subsection{Question 1.1}
\label{sec:org54c8e06}
