...
\label{sec:orgf782710}
\subsubsection{\texttt{try-these}}
\label{sec:org5d8e069}
...
\label{sec:orge429246}
\subsection{Question}
\label{sec:orgfc0cc8f}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:org445fe67}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:org21585a5}
\subsection{Question}
\label{sec:org4b13992}
...
\label{sec:org68d297b}
\subsection{Text}
\label{sec:orgd47f511}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:org78f6468}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:org37ab54f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgcca07d8}
\subsection{Question}
\label{sec:org1cdc16a}
...
\label{sec:org8d273ab}
\subsection{Question}
\label{sec:org115976c}
...
\label{sec:org66832b4}
\subsection{Text code}
\label{sec:orgc6f6fd4}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:orge350b07}
\subsection{Text}
\label{sec:org7d7217e}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:orgb8b6ebb}
...
\subsection{Diary}
\label{sec:org0a0bdf0}
\subsubsection{Solving}
\label{sec:orgcc0a3ac}
...
\label{sec:orgd083f9b}
\begin{enumerate}
\item Non-optimized
\label{sec:org8baeeaa}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:orgc1697ba}
\subsection{Question}
\label{sec:orgf6db8b9}
...
\label{sec:org27e1e81}
\subsection{Question}
\label{sec:org72a5bb3}
...
\label{sec:orgd7ebe8e}
\subsection{Question}
\label{sec:org65bb838}
...
\subsection{Answer}
\label{sec:org19092a9}
\subsubsection{\texttt{f}}
\label{sec:orgb4b9870}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<try-these>>
<<EX1-10-defs>>
...
\label{sec:org0fc41de}
\subsection{Question}
\label{sec:orgf9fb607}
...
\subsection{Answer}
\label{sec:orga815ea3}
\subsubsection{Recursive}
\label{sec:org3acf61f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org757e406}
\begin{enumerate}
\item Attempt 1
\label{sec:org05edd21}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org62e6dbe}
\subsection{Question}
\label{sec:orgbb4fe78}
...
\label{sec:org0b045b0}
\subsection{Question}
\label{sec:org0efb590}
...
\label{sec:org90f0b8d}
\subsection{Question 1}
\label{sec:orgfc2ceee}
...
\label{sec:orgb936f91}
\subsection{Text}
\label{sec:orgb1c6cd1}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org2c193d5}
\subsection{Question}
\label{sec:org9b5bc71}
...
\label{sec:org396e9f8}
\subsection{Question}
\label{sec:org4bdc835}
Using the results of \hyperref[sec:orgb936f91]{Exercise 1.16} and \hyperref[sec:org2c193d5]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org696bb27}
\subsubsection{Comparison benchmarks:}
\label{sec:org39f9497}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(load "../mattbench.scm")
<<fast-mult-iter>>
<<fast-mult-rec>>
...
\label{sec:org98ad3dc}
\subsection{Question}
\label{sec:org636ea31}
...
\label{sec:orga76ddef}
\subsection{Text}
\label{sec:org4bbfd7f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org4e1127a}
\subsection{Text}
\label{sec:org713acfa}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org3e8c6bc}
\subsection{Question}
\label{sec:orge57a8d3}
...
\subsection{Answer}
\label{sec:orgbe6b4f3}
\subsubsection{Part 1}
\label{sec:org1d94952}
...
\label{sec:org88d9bd7}
\subsection{Question}
\label{sec:orgf7982bd}
...
\label{sec:org3032448}
\subsection{Text}
\label{sec:org84905d9}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org60ac79b}
\subsection{Question}
\label{sec:org51aa6a6}
...
\label{sec:org5fce72e}
\subsection{Question}
\label{sec:org53897dd}
...
\label{sec:orge81e6c6}
\subsection{Question}
\label{sec:org9a73100}
...
\label{sec:orgfedb2dc}
\subsection{Question}
\label{sec:orgb95c867}
