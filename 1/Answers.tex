...
\label{sec:org5903761}
\subsubsection*{\texttt{try-these}}
\label{sec:org898c634}
...
\label{sec:org1aa1138}
\subsection{Question}
\label{sec:orga67fe87}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:orgeac4d52}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:orgb22e130}
\subsection{Question}
\label{sec:orge0173b8}
...
\label{sec:org2fa2b0f}
\subsection{Text}
\label{sec:org176f6d0}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:orgbf07e75}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:org6c18783}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org0ff62c0}
\subsection{Question}
\label{sec:org10d128d}
...
\label{sec:orgc6fcab9}
\subsection{Question}
\label{sec:org693241c}
...
\label{sec:orgc1aa30c}
\subsection{Text code}
\label{sec:orgf695220}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:org2dc62de}
\subsection{Text}
\label{sec:org00db0c5}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:org4de7057}
...
\subsection{Diary}
\label{sec:org5c56b01}
\subsubsection{Solving}
\label{sec:orgbd28b1f}
...
\label{sec:org123b54a}
\begin{enumerate}
\item Non-optimized
\label{sec:orgd970604}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:orgb4854de}
\subsection{Question}
\label{sec:orgd3cb327}
...
\label{sec:org721a236}
\subsection{Question}
\label{sec:orgdd5b253}
...
\label{sec:org2b46fe5}
\subsection{Question}
\label{sec:orgc2ffd10}
...
\subsection{Answer}
\label{sec:org33ceaea}
\subsubsection{\texttt{f}}
\label{sec:orgd0a6c7d}
...
\label{sec:orgefdf15b}
\subsection{Question}
\label{sec:org47fdd33}
...
\subsection{Answer}
\label{sec:orgc3ffc5c}
\subsubsection{Recursive}
\label{sec:org496f289}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org3302722}
\begin{enumerate}
\item Attempt 1
\label{sec:orgd1704e8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgd4974ec}
\subsection{Question}
\label{sec:orgb7c457b}
...
\label{sec:orged985c5}
\subsection{Question}
\label{sec:orgd875f2b}
...
\label{sec:org3a7c667}
\subsection{Question A}
\label{sec:org1ef0a09}
...
\label{sec:orgdc23f52}
\subsection{Text}
\label{sec:org3da00fa}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:orge5f75e8}
\subsection{Question}
\label{sec:orgf1b685e}
...
\label{sec:org702af67}
\subsection{Question}
\label{sec:orga310669}
Using the results of \hyperref[sec:orgdc23f52]{Exercise 1.16} and \hyperref[sec:orge5f75e8]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org6e2f570}
\subsubsection{Comparison benchmarks:}
\label{sec:org2767cad}
...
\label{sec:orgbd6cc65}
\subsection{Question}
\label{sec:org606840f}
...
\label{sec:org00993b3}
\subsection{Text}
\label{sec:orgf0bbc43}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:orgd8603c8}
\subsection{Text}
\label{sec:orga282087}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org5c29975}
\subsection{Question}
\label{sec:org89bd889}
...
\subsection{Answer}
\label{sec:org7931a5e}
\subsubsection{Part 1}
\label{sec:org635eb42}
...
\label{sec:org104a78b}
\subsection{Question}
\label{sec:orgecba892}
...
\label{sec:orgef30e07}
\subsection{Text}
\label{sec:orgb87109b}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org2a3131a}
\subsection{Question}
\label{sec:org7829042}
...
\label{sec:orgbc3b5ed}
\subsection{Question}
\label{sec:org30e212e}
...
\label{sec:org7ee0ead}
\subsection{Question}
\label{sec:org589111a}
...
\label{sec:org04477dc}
\subsection{Question}
\label{sec:org71c5a31}
...
\label{sec:org8f6f300}
\subsection{Text}
\label{sec:orgc718702}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org3f48147}
\subsection{Question}
\label{sec:org97adc08}
...
\label{sec:org3ccbedc}
\subsection{Question A.1}
\label{sec:org62b8b00}
...
\subsection{Answer 1.3}
\label{sec:org9baa909}
...
\label{sec:org7b0a0a4}
\subsection{Question A}
\label{sec:orged370e3}
...
\label{sec:org2c562b3}
\subsection{Question A}
\label{sec:org221bd33}
\index{filter}
...
\label{sec:org367d6e0}
\subsection{Question}
\label{sec:org197fbac}
...
\label{sec:org33758e3}
\subsection{Text}
\label{sec:org352d127}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org9dd36eb}
\subsection{Question}
\label{sec:orgc25a7a5}
...
\label{sec:orgdd18242}
\subsection{Question A}
\label{sec:org6c03b64}
