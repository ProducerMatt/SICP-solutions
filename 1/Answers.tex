...
\label{sec:org8f0c4bb}
\subsubsection{\texttt{try-these}}
\label{sec:org3e9d53b}
...
\label{sec:org64d4771}
\subsection{Question}
\label{sec:orgac03512}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:org94336ca}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:orgdec1b6d}
\subsection{Question}
\label{sec:orga17d5fe}
...
\label{sec:org9a9b070}
\subsection{Text}
\label{sec:org70da6e0}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:orgb414d21}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:org5cc4c5f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org86ca118}
\subsection{Question}
\label{sec:orga335318}
...
\label{sec:org7be32c1}
\subsection{Question}
\label{sec:org60b74d4}
...
\label{sec:org30ee729}
\subsection{Text code}
\label{sec:orgcc6074c}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:org3741fc5}
\subsection{Text}
\label{sec:orga338341}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:org2158fc1}
...
\subsection{Diary}
\label{sec:org2018636}
\subsubsection{Solving}
\label{sec:orgb73f604}
...
\label{sec:org93b4631}
\begin{enumerate}
\item Non-optimized
\label{sec:org431bc27}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:orgc342b18}
\subsection{Question}
\label{sec:org36acebc}
...
\label{sec:orgb7876cc}
\subsection{Question}
\label{sec:orgfbb42b4}
...
\label{sec:org0e8499b}
\subsection{Question}
\label{sec:org3d21482}
...
\subsection{Answer}
\label{sec:orgae94454}
\subsubsection{\texttt{f}}
\label{sec:org94ec504}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<try-these>>
<<EX1-10-defs>>
...
\label{sec:org0f5968b}
\subsection{Question}
\label{sec:org06d7f59}
...
\subsection{Answer}
\label{sec:org10485b8}
\subsubsection{Recursive}
\label{sec:orga76c2d1}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org925114a}
\begin{enumerate}
\item Attempt 1
\label{sec:orgd8e02c1}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgb9b9424}
\subsection{Question}
\label{sec:org15d02af}
...
\label{sec:orgaa71b13}
\subsection{Question}
\label{sec:org6dfb5a1}
...
\label{sec:org669aee4}
\subsection{Question 1}
\label{sec:org3e140dd}
...
\label{sec:org45c55eb}
\subsection{Text}
\label{sec:org85c38c0}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:orgf2947cd}
\subsection{Question}
\label{sec:orgdc91f99}
...
\label{sec:org6f16603}
\subsection{Question}
\label{sec:orgcb0a762}
Using the results of \hyperref[sec:org45c55eb]{Exercise 1.16} and \hyperref[sec:orgf2947cd]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org81082ef}
\subsubsection{Comparison benchmarks:}
\label{sec:org717b070}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(load "../mattbench.scm")
<<fast-mult-iter>>
<<fast-mult-rec>>
...
\label{sec:org9e06e10}
\subsection{Question}
\label{sec:org4c23445}
...
\label{sec:orgb3f3e90}
\subsection{Text}
\label{sec:orgdadf6ef}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org5826c98}
\subsection{Text}
\label{sec:org2587744}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org19f92b4}
\subsection{Question}
\label{sec:org41c2eb3}
...
\subsection{Answer}
\label{sec:orge1e8b8e}
\subsubsection{Part 1}
\label{sec:org9434e28}
...
\label{sec:org494590e}
\subsection{Question}
\label{sec:org8800292}
...
\label{sec:org2bff742}
\subsection{Text}
\label{sec:org0c50809}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org2111e88}
\subsection{Question}
\label{sec:orgd6e8950}
...
\label{sec:org319dab9}
\subsection{Question}
\label{sec:orgc3acf09}
...
\label{sec:org9342c7b}
\subsection{Question}
\label{sec:org20ffb09}
...
\label{sec:org0d1f2b2}
\subsection{Question}
\label{sec:orgf51b2ad}
