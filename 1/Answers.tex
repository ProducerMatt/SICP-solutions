...
\label{sec:orgfe0d57c}
\subsection{Text Foreword}
\label{sec:org6deb585}
...
\label{sec:orgfe45136}
\begin{description}
\item[{Black-box abstraction}] Encapsulating an operation so the details of it are irrelevant.
...
\item Combination: combine procedures with \emph{composition}, combine data with \emph{construction} of compound data.
...
\begin{description}
\item[{Object-oriented programming}] thinking of your structure as a society of discrete but interacting parts.
\item[{Operations on aggregates}] thinking of your structure as operating on a stream, comparable to signal processing. \emph{(Needs clarification.)}
\end{description}
\end{itemize}
...
\section{Chapter 1}
\label{sec:orgfc0942a}
\subsection{1: Building Abstractions with Procedures}
\label{sec:orgda4aefd}
...
\begin{center}
\includegraphics[width=.9\linewidth]{fig/t_1-1-3.png}
\end{center}

\subsection{1.1.4: Compound Procedures}
\label{sec:orgd845843}
...
\label{sec:org64ed535}
\subsubsection{Question}
\label{sec:org0084690}
\begin{quote}
...
\label{sec:org7b5d1df}
\subsubsection{Question}
\label{sec:orgae4110a}
\begin{quote}
...
\label{sec:org6c186d2}
\subsubsection{Question}
\label{sec:org2b4ba21}
\begin{quote}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\end{quote}
\subsubsection{Answer}
\label{sec:orgffa6bac}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orge2ba4ef}
\subsubsection{Question}
\label{sec:org7294a33}
\begin{quote}
...
\label{sec:orgef6cc4e}
\subsubsection{Question}
\label{sec:org5c5b51d}
\begin{quote}
...
\label{sec:org66b1bae}
\subsubsection{Text code}
\label{sec:org7247d79}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
      (- x)
...
\label{sec:org4ff3d1e}
\subsubsection{Text}
\label{sec:org62e5b3a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsubsection{Question}
\label{sec:org4c1f58b}
\begin{quote}
...
\end{quote}
\subsubsection{Diary}
\label{sec:org301352e}
\begin{enumerate}
\item Solving
\label{sec:org17c5109}
...
\label{sec:org838f3df}
\begin{enumerate}
\item Non-optimized
\label{sec:org13881ee}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org5e10cf5}
\subsubsection{Question}
\label{sec:org5c7a82f}
\begin{quote}
...
\label{sec:org801dd1f}
\subsubsection{Question}
\label{sec:orgdf29659}
\begin{quote}
...
\label{sec:org78e9a67}
\subsubsection{Question}
\label{sec:orgb1536f5}
\begin{quote}
...
\subsubsection{Answer}
\label{sec:org2cb7a77}
\begin{enumerate}
\item \texttt{f}
\label{sec:orgd5f3497}
...
The resulting process splits into two with every iteration, creating a tree of computations, many of which are duplicates of previous computations. This kind of pattern is called \textbf{tree-recursion}. However, this one is quite inefficient. The time and space required grows exponentially with the number of iterations requested.

Instead, it makes much more sense to start from \texttt{Fib(1) \textasciitilde{} 1} and \texttt{Fib(0) \textasciitilde{} 0} and iterate upwards to the desired value. This only requires a linear number of steps relative to the input.
...
\end{quote}
\subsubsection{Answer}
\label{sec:org6c7ded3}
\begin{enumerate}
\item Recursive
\label{sec:orgc96ee04}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\item Iterative
\label{sec:org57f5ecb}
\begin{enumerate}
\item Attempt 1
\label{sec:orgbbe5c19}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org103850b}
\subsubsection{Question}
\label{sec:org8fe8fba}
\begin{quote}
...
\label{sec:orgccf3b61}
\subsubsection{Question}
\label{sec:org17db99c}
\begin{quote}
...
\item[{Tree-recursive}] means in general, time is proportional to the number of nodes, space
\end{description}
is proportional to the depth of the tree. In the Fibonacci algorithm example,
\(\Theta(n)\) and time \(\Theta(\Upsilon^{n})\) where \(\Upsilon\) is the golden
...
I'm not going to include the full printout of the \mintinline[breaklines=true,breakanywhere=true,linenos=true]{scheme}{(count-change 11)}, here's an
example of what this looks like via \texttt{1}.
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org7eb5118}
\subsubsection{Question A}
\label{sec:org2d487d6}
\begin{quote}
...
\label{sec:orgac345a1}
\subsubsection{Text}
\label{sec:orgae0b512}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:orge80c048}
\subsubsection{Question}
\label{sec:org3713208}
\begin{quote}
...
\label{sec:org8eee422}
\subsubsection{Question}
\label{sec:orgdab0651}
\begin{quote}
Using the results of \hyperref[sec:orgac345a1]{Exercise 1.16} and \hyperref[sec:orge80c048]{Exercise 1.17}, devise a procedure that
...
\end{quote}
\subsubsection{Diary}
\label{sec:org8efe894}
\begin{enumerate}
\item Comparison benchmarks:
\label{sec:orgda9fd0b}
...
\label{sec:org78dab9e}
\subsubsection{Question}
\label{sec:org1707020}
\begin{quote}
...
\begin{quote}
\textbf{Lamé's Theorem:} If Euclid's Algorithm requires \(k\) steps to compute the GCD of some pair, then the smaller number in the pair must be greater than or equal to the \(k^{th}\)Fibonacci number.
\end{quote}

\subsection{Exercise 1.20}
\label{sec:org225c844}
\subsubsection{Text}
\label{sec:org647f410}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:orgc435fad}
Two algorithms for testing primality of numbers.

\begin{enumerate}
\item \(\Theta(\sqrt{n})\): Start with \(x = 2\), check for divisibility with \(n\), if not then increment \(x\) by 1 and check again. If \(x^2 > n\) and you haven't found a divisor, \(n\) is prime.
\item \(\Theta(\log n)\): Given a number \(n\), pick a random number \(a < n\) and compute the remainder of \(a^n\) modulo \(n\). If the result is not equal to \(a\), then \(n\) is certainly not prime. If it is \(a\), then chances are good that \(n\) is prime. Now pick another random number \(a\) and test it with the same method. If it also satisfies the equation, then we can be even more confident that \(n\) is prime. By trying more and more values of \(a\), we can increase our confidence in the result. This algorithm is known as the Fermat test.
\end{enumerate}

\begin{quote}
\textbf{Fermat's Little Theorem:} If \(n\) is a prime number and \(a\) is any positive integer less than \(n\), then \(a\) raised to the \(n^{th}\) power is congruent to \(a\) modulo \(n\). [Two numbers are \emph{congruent modulo} \(n\) if they both have the same remainder when divided by \(n\).]
\end{quote}
...
\label{sec:org6d3d755}
\subsubsection{Text}
\label{sec:org9b94c43}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org86f07eb}
\subsubsection{Question}
\label{sec:org486eba7}
\begin{quote}
...
\subsubsection{Answer}
\label{sec:org9cf7dc3}
\begin{enumerate}
\item Part 1
\label{sec:org0968c68}
...
\label{sec:org048b708}
\subsubsection{Question}
\label{sec:orgbd29a2e}
\begin{quote}
...
\label{sec:org2e44c08}
\subsubsection{Text}
\label{sec:orgc086bf3}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org49375f9}
\subsubsection{Question}
\label{sec:org382d11a}
\begin{quote}
...
\label{sec:orgb1ce5d0}
\subsubsection{Question}
\label{sec:org4e42d62}
\begin{quote}
...
\label{sec:org46dd596}
\subsubsection{Question}
\label{sec:org003ff92}
\begin{quote}
...
\label{sec:orgf789d1d}
\subsubsection{Question}
\label{sec:orgb7225ae}
\begin{quote}
...
\label{sec:org9d5ac5e}
\subsubsection{Text}
\label{sec:org02e46a6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (sum term a next b)
  (if (> a b)
      0
...
\label{sec:org63fead1}
\subsubsection{Question}
\label{sec:orgaa224a7}
\begin{quote}
...
\label{sec:org0788cee}
\subsubsection{Question A.1}
\label{sec:org71004eb}
\begin{quote}
...
\label{sec:orgeb1a584}
\subsubsection{Question A}
\label{sec:org84f7be5}
\begin{quote}
...
\label{sec:org3064791}
\subsubsection{Question A}
\label{sec:org2f07770}
\index{filter}
\begin{quote}
...
\label{sec:org7b71950}
\subsubsection{Question}
\label{sec:org1f434cd}
\begin{quote}
...
\label{sec:org776cdd5}
\subsubsection{Text}
\label{sec:org94b1d25}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org7d1d1bf}
\subsubsection{Question}
\label{sec:org2ad63bd}
\begin{quote}
...
\label{sec:org6a212a5}
\subsubsection{Question A}
\label{sec:org81994c4}
\begin{quote}
...
\label{sec:orgedef6d7}
\subsubsection{Question}
\label{sec:orge69c7f3}
\begin{quote}
...
\label{sec:orgeefa240}
\subsubsection{Question}
\label{sec:org42cdc6c}
\begin{quote}
...
\label{sec:org3b2a4b4}
\subsubsection{Text}
\label{sec:orgb41f6bb}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org56e331f}
\subsubsection{Question}
\label{sec:orga549763}
\begin{quote}
...
\label{sec:org698813d}
\subsubsection{Question}
\label{sec:org2311196}
\begin{quote}
...
\label{sec:org5995c6d}
\subsubsection{Question}
\label{sec:orgfb153ae}
\begin{quote}
...
\label{sec:orgc261160}
\subsubsection{Question}
\label{sec:orge2c17b1}
\index{smoothing}
\begin{quote}
...
\label{sec:org71e4a34}
\subsubsection{Question}
\label{sec:org426d4d9}
\begin{quote}
...
\label{sec:orge02a235}
\subsubsection{Question}
\label{sec:org6f93c30}
\begin{quote}
...
<<fixed-point-txt>>
<<fixed-point-improve>>
(mattcheck-equal "fixed-point-improve still working"
                 (fixed-point (λ(x)(+ 1 (/ 1 x))) 1.0)
                 (fixed-point-improve (λ(x)(+ 1 (/ 1 x))) 1.0))
<<sqrt>>
<<sqrt-improve>>
(mattcheck-equal "sqrt-improve still working"
                 (sqrt 5)
                 (sqrt 5))
\end{minted}
