...
\label{sec:org15bbb6d}
\subsubsection{\texttt{try-these}}
\label{sec:orgb64797a}
...
(define* (print-table table #:key (colnames #f) (mode #f))
  (let ((fmtstr
    ...
    (define* (print-row ll #:key (fmt fmtstr))
      (format #t "~&|")
...
\label{sec:org1db89c6}
\subsection{Question}
\label{sec:org79fe6ae}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:orgcdcb799}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:org88e1dc2}
\subsection{Question}
\label{sec:org9b30bec}
...
\label{sec:org9f7ae85}
\subsection{Text}
\label{sec:orgb6df4a8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:org56f51ff}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:org9f49dc8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgd122bc2}
\subsection{Question}
\label{sec:orgbcd9143}
...
\label{sec:orgcda6219}
\subsection{Question}
\label{sec:org2de081f}
...
\label{sec:orgf677e6f}
\subsection{Text code}
\label{sec:orgf7a6eea}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:orge570c03}
\subsection{Text}
\label{sec:org0c410ae}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:org26e109a}
...
\subsection{Diary}
\label{sec:orge5167e6}
\subsubsection{Solving}
\label{sec:org5a0ae48}
...
\label{sec:org6e8b021}
\begin{enumerate}
\item Non-optimized
\label{sec:org96ea154}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:org3a2e867}
\subsection{Question}
\label{sec:orgf552d57}
...
\label{sec:orgee05e5a}
\subsection{Question}
\label{sec:org81c87a0}
...
\label{sec:orgfea0146}
\subsection{Question}
\label{sec:orgd44001b}
...
\subsection{Answer}
\label{sec:org03f8144}
\subsubsection{\texttt{f}}
\label{sec:org00f3755}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<try-these>>
<<EX1-10-defs>>
...
\label{sec:org8c7ecb2}
\subsection{Question}
\label{sec:orgf9c7833}
...
\subsection{Answer}
\label{sec:orge107953}
\subsubsection{Recursive}
\label{sec:org475b46d}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org1b283c9}
\begin{enumerate}
\item Attempt 1
\label{sec:orgd710cf9}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org9f6cf05}
\subsection{Question}
\label{sec:org7e81741}
...
\label{sec:org878dd15}
\subsection{Question}
\label{sec:orgd88ba04}
...
\label{sec:org83c8e56}
\subsection{Question 1}
\label{sec:orgff1c5c5}
...
\label{sec:orgd3afe4f}
\subsection{Text}
\label{sec:orgab5c04c}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:orgbe985ba}
\subsection{Question}
\label{sec:org7875fdc}
...
\label{sec:org5a6575a}
\subsection{Question}
\label{sec:org969bfd4}
Using the results of \hyperref[sec:orgd3afe4f]{Exercise 1.16} and \hyperref[sec:orgbe985ba]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org1a016e9}
\subsubsection{Comparison benchmarks:}
\label{sec:orgc63deb4}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(load "../mattbench.scm")
<<fast-mult-iter>>
<<fast-mult-rec>>
...
\label{sec:org0520811}
\subsection{Question}
\label{sec:org45c74b9}
...
\label{sec:org22b1504}
\subsection{Text}
\label{sec:orge2a7367}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:orgf70a8e8}
\subsection{Text}
\label{sec:orgccc7266}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgdb16aac}
\subsection{Question}
\label{sec:org349f2a6}
...
\subsection{Answer}
\label{sec:orgdb615a3}
\subsubsection{Part 1}
\label{sec:org1aaddfa}
...
(define (mattbench2 f n)
  ...
  ;; Returns a dotted pair with car(last execution results) and cdr(time taken divided by iterations n)
  ...
  (define (iter i)
    (f)
    (if (<= i 0)
        (f) ;; return the results of the function
        (iter (- i 1))))
...
(define (testit name f)
  (list name
        (cadr (mattbench2 (λ() (f 1000 3)) benchmark-iterations))
...
(print-table
 (list (list "function" ">1000" ">100000" ">1000000" ">10000000")
       (testit "smallest-divisor" search-for-primes))
    #:colnames #t)
\end{minted}
...
\centering
\begin{tabular}{lrrrr}
function & >1000 & >100000 & >1000000 & >10000000\\
\hline
smallest-divisor & 5449.59114 & 20678.07188 & 53432.40465 & 122270.00802\\
\end{tabular}
\end{table}
...
plot data using 1:2 with lines title 'time to find primes', \
     data using 1:(f($1)) with lines title \
     sprintf('sqrt(x * %.2f + 1000)', a)
\end{minted}
