...
\label{sec:org2b0fc6a}
\subsubsection{\texttt{try-these}}
\label{sec:org4028967}
...
\label{sec:org351d3f1}
\subsection{Question}
\label{sec:orgef9b9c6}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:org83c712a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:org386ca39}
\subsection{Question}
\label{sec:org5643b57}
...
\label{sec:org650b067}
\subsection{Text}
\label{sec:orgc1e621b}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:orgac04c66}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:org5444d81}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org5d7588f}
\subsection{Question}
\label{sec:org243585b}
...
\label{sec:orgbf5cd92}
\subsection{Question}
\label{sec:orgbcb2f60}
...
\label{sec:org84d5562}
\subsection{Text code}
\label{sec:orgfee91d2}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:orgeeb5e51}
\subsection{Text}
\label{sec:org8b244d6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:org6a4e471}
...
\subsection{Diary}
\label{sec:org4cdea59}
\subsubsection{Solving}
\label{sec:org72f5ae1}
...
\label{sec:org045aa2f}
\begin{enumerate}
\item Non-optimized
\label{sec:org377b5b5}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:orgde780b5}
\subsection{Question}
\label{sec:org7501ddc}
...
\label{sec:orga75750e}
\subsection{Question}
\label{sec:org8b84ba5}
...
\label{sec:org771cdc8}
\subsection{Question}
\label{sec:orgec1e663}
...
\subsection{Answer}
\label{sec:org5fbf681}
\subsubsection{\texttt{f}}
\label{sec:org3c6385f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<try-these>>
<<EX1-10-defs>>
...
\label{sec:orgb8eb69d}
\subsection{Question}
\label{sec:orge4c21bf}
...
\subsection{Answer}
\label{sec:orgf462dea}
\subsubsection{Recursive}
\label{sec:org86f01be}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org776f01b}
\begin{enumerate}
\item Attempt 1
\label{sec:org2756f74}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org11a640d}
\subsection{Question}
\label{sec:org1954b92}
...
\label{sec:org9eb8196}
\subsection{Question}
\label{sec:org19bc221}
...
\label{sec:org2d9a70e}
\subsection{Question 1}
\label{sec:org766662d}
...
\label{sec:org8a3c571}
\subsection{Text}
\label{sec:org04998d5}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org9330f09}
\subsection{Question}
\label{sec:org7c79e90}
...
\label{sec:orga608e54}
\subsection{Question}
\label{sec:org5914c0a}
Using the results of \hyperref[sec:org8a3c571]{Exercise 1.16} and \hyperref[sec:org9330f09]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org20542ba}
\subsubsection{Comparison benchmarks:}
\label{sec:org92cf2c6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(load "../mattbench.scm")
<<fast-mult-iter>>
<<fast-mult-rec>>
...
\label{sec:orge526bb5}
\subsection{Question}
\label{sec:org9b25e39}
...
\label{sec:org3ffca60}
\subsection{Text}
\label{sec:org0d5528f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:orga61143e}
\subsection{Text}
\label{sec:org49a74aa}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgaf3a496}
\subsection{Question}
\label{sec:org37b5964}
...
\subsection{Answer}
\label{sec:org0cde7e6}
\subsubsection{Part 1}
\label{sec:orgbad2b63}
...
\label{sec:orga1d816c}
\subsection{Question}
\label{sec:orgc964e3a}
