...
\label{sec:org670d7c2}
\subsubsection{\texttt{try-these}}
\label{sec:orgfa4053d}
...
\label{sec:orgfc47fda}
\subsection{Question}
\label{sec:orge343c29}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:orgd22e2bd}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:orgfccbc2b}
\subsection{Question}
\label{sec:orgb64e644}
...
\label{sec:org22c383a}
\subsection{Text}
\label{sec:orga8532f0}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:orgb8b89c0}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:orgc14f238}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgdd399b2}
\subsection{Question}
\label{sec:org934552f}
...
\label{sec:orgca59fb4}
\subsection{Question}
\label{sec:orgcaba4e2}
...
\label{sec:org81b18e4}
\subsection{Text code}
\label{sec:org4ff2b83}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:org65b4670}
\subsection{Text}
\label{sec:orgbf09f26}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:orgf82076c}
...
\subsection{Diary}
\label{sec:org086a31b}
\subsubsection{Solving}
\label{sec:org85d1c76}
...
\label{sec:orgd632372}
\begin{enumerate}
\item Non-optimized
\label{sec:org153edcf}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:orgc9c1b95}
\subsection{Question}
\label{sec:orgd4baae8}
...
\label{sec:orgc0da9bc}
\subsection{Question}
\label{sec:orgf122211}
...
\label{sec:orgdaf86d1}
\subsection{Question}
\label{sec:orgb30587c}
...
\subsection{Answer}
\label{sec:org039e3b2}
\subsubsection{\texttt{f}}
\label{sec:org7219413}
...
\label{sec:orgdb879be}
\subsection{Question}
\label{sec:org9f42e00}
...
\subsection{Answer}
\label{sec:orgeda3325}
\subsubsection{Recursive}
\label{sec:org2b4295b}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org214ea84}
\begin{enumerate}
\item Attempt 1
\label{sec:orgb0d3766}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgd7af1ff}
\subsection{Question}
\label{sec:orgb425f03}
...
\label{sec:org9fbeba8}
\subsection{Question}
\label{sec:org3920050}
...
\label{sec:org4a8d1f1}
\subsection{Question 1}
\label{sec:orgb3a6cc9}
...
\label{sec:org78bf3b9}
\subsection{Text}
\label{sec:orgf46f05a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:orgbfd5f7e}
\subsection{Question}
\label{sec:orge50ec19}
...
\label{sec:org2e78270}
\subsection{Question}
\label{sec:orge2b0107}
Using the results of \hyperref[sec:org78bf3b9]{Exercise 1.16} and \hyperref[sec:orgbfd5f7e]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org62500ea}
\subsubsection{Comparison benchmarks:}
\label{sec:orge0e2185}
...
\label{sec:org0255cd9}
\subsection{Question}
\label{sec:orgad386b1}
...
\label{sec:orgb72ce6d}
\subsection{Text}
\label{sec:org424f219}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:orga19a3d6}
\subsection{Text}
\label{sec:org70f4249}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org0bff324}
\subsection{Question}
\label{sec:orgc780751}
...
\subsection{Answer}
\label{sec:orgcd98b93}
\subsubsection{Part 1}
\label{sec:orgd846885}
...
\label{sec:orgcf5ae37}
\subsection{Question}
\label{sec:org75867c4}
...
\label{sec:orge2989a0}
\subsection{Text}
\label{sec:org8da78dd}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org03e970c}
\subsection{Question}
\label{sec:orgd684f65}
...
\label{sec:org9f8cc0b}
\subsection{Question}
\label{sec:org8cd3b7a}
...
\label{sec:orgc87bee3}
\subsection{Question}
\label{sec:orgf8f3368}
...
\label{sec:orgcba40ed}
\subsection{Question}
\label{sec:orge7200c4}
...
\label{sec:org114a77e}
\subsection{Text}
\label{sec:org96a5d54}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgae23892}
\subsection{Question}
\label{sec:orgbacc2fc}
