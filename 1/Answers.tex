...
\label{sec:org5580ab9}
\subsubsection{\texttt{try-these}}
\label{sec:org860a72b}
...
\label{sec:orgb922d5f}
\subsection{Question}
\label{sec:org649519c}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:orgf5a71e6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:org2bfa987}
\subsection{Question}
\label{sec:org7556b48}
...
\label{sec:orge716b6f}
\subsection{Text}
\label{sec:org6cad1ef}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:orga9b33be}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:orgca65878}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgc435ad6}
\subsection{Question}
\label{sec:orgf3ba98a}
...
\label{sec:orgb51626f}
\subsection{Question}
\label{sec:orgacf30f5}
...
\label{sec:org0ded96a}
\subsection{Text code}
\label{sec:org22eebac}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:org5cee198}
\subsection{Text}
\label{sec:orga29a79c}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:orgd604129}
...
\subsection{Diary}
\label{sec:org72557b7}
\subsubsection{Solving}
\label{sec:org437828b}
...
\label{sec:orgae47718}
\begin{enumerate}
\item Non-optimized
\label{sec:org177c570}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:org9a25494}
\subsection{Question}
\label{sec:org1c37f37}
...
\label{sec:orgaa2c4ab}
\subsection{Question}
\label{sec:orgdf72d85}
...
\label{sec:orgfc83297}
\subsection{Question}
\label{sec:orgd998758}
...
\subsection{Answer}
\label{sec:orgc6d2695}
\subsubsection{\texttt{f}}
\label{sec:org5001254}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<try-these>>
<<EX1-10-defs>>
...
\label{sec:org71c0cd1}
\subsection{Question}
\label{sec:org8d414a8}
...
\subsection{Answer}
\label{sec:org6f845b8}
\subsubsection{Recursive}
\label{sec:orgc21c365}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org371ee92}
\begin{enumerate}
\item Attempt 1
\label{sec:org18e9c66}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org31c3680}
\subsection{Question}
\label{sec:org022510a}
...
\label{sec:orge60ef0d}
\subsection{Question}
\label{sec:org8f5a590}
...
\label{sec:orge26253b}
\subsection{Question 1}
\label{sec:org8a6bad9}
...
\label{sec:orgca182eb}
\subsection{Text}
\label{sec:org3f5c8c6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org2a2d2f4}
\subsection{Question}
\label{sec:orgb64cbc5}
...
\label{sec:org7145fa4}
\subsection{Question}
\label{sec:orgf5cc72b}
Using the results of \hyperref[sec:orgca182eb]{Exercise 1.16} and \hyperref[sec:org2a2d2f4]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org3d8946a}
\subsubsection{Comparison benchmarks:}
\label{sec:orgca05739}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(load "../mattbench.scm")
<<fast-mult-iter>>
<<fast-mult-rec>>
...
\label{sec:org1f43ffd}
\subsection{Question}
\label{sec:org253d90c}
...
\label{sec:org5d98772}
\subsection{Text}
\label{sec:orga2dea3d}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org0ce2ccf}
\subsection{Text}
\label{sec:orgc11287a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org704ac0b}
\subsection{Question}
\label{sec:org0f44b4f}
...
\subsection{Answer}
\label{sec:orgfa9f3ce}
\subsubsection{Part 1}
\label{sec:org55def67}
...
\label{sec:org5da23cf}
\subsection{Question}
\label{sec:orge3b6806}
...
\label{sec:orgbf15ce9}
\subsection{Text}
\label{sec:orgaae34ca}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org82f0106}
\subsection{Question}
\label{sec:org4dfe17d}
...
\label{sec:org3d8abdf}
\subsection{Question}
\label{sec:org26a88c7}
...
\label{sec:orgcb91825}
\subsection{Question}
\label{sec:orgc858abe}
