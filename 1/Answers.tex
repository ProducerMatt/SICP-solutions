...
\label{sec:org1fc566a}
\subsubsection*{\texttt{try-these}}
\label{sec:orgc00bda1}
...
\label{sec:orgde07d61}
\subsection{Question}
\label{sec:org15e190a}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:org5f14b9b}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:org79e3610}
\subsection{Question}
\label{sec:org09043a1}
...
\label{sec:org7168303}
\subsection{Text}
\label{sec:orgda3a7a1}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:org2a48df8}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:org873d9b2}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org1097c63}
\subsection{Question}
\label{sec:org7d972a3}
...
\label{sec:org2dc3e2c}
\subsection{Question}
\label{sec:org9ebbbb9}
...
\label{sec:orgd97ccc1}
\subsection{Text code}
\label{sec:org3d1655d}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:orgd94d824}
\subsection{Text}
\label{sec:org7ed6876}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:org4f04360}
...
\subsection{Diary}
\label{sec:orgd802755}
\subsubsection{Solving}
\label{sec:org97c6022}
...
\label{sec:org4b5a95c}
\begin{enumerate}
\item Non-optimized
\label{sec:orgb9a6661}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:orgea633b6}
\subsection{Question}
\label{sec:org3dd2a26}
...
\label{sec:orgf243d71}
\subsection{Question}
\label{sec:orgbfc74ef}
...
\label{sec:org3f433a8}
\subsection{Question}
\label{sec:orgc13d46a}
...
\subsection{Answer}
\label{sec:org762ef68}
\subsubsection{\texttt{f}}
\label{sec:orgc893ce8}
...
\label{sec:org68b01f2}
\subsection{Question}
\label{sec:orgce00f35}
...
\subsection{Answer}
\label{sec:org2fa3a32}
\subsubsection{Recursive}
\label{sec:org27de257}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:orge29635c}
\begin{enumerate}
\item Attempt 1
\label{sec:orgf39909a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgdc2879b}
\subsection{Question}
\label{sec:org81c1b43}
...
\label{sec:org795eafb}
\subsection{Question}
\label{sec:org9bac256}
...
\label{sec:org4fd5616}
\subsection{Question A}
\label{sec:org8cb485f}
...
\label{sec:org7637f56}
\subsection{Text}
\label{sec:orgec69a77}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org2dfa314}
\subsection{Question}
\label{sec:orgad08dc6}
...
\label{sec:orgc2ebf53}
\subsection{Question}
\label{sec:org3bca0ec}
Using the results of \hyperref[sec:org7637f56]{Exercise 1.16} and \hyperref[sec:org2dfa314]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org0aa15ec}
\subsubsection{Comparison benchmarks:}
\label{sec:orgb9847d6}
...
\label{sec:orge032734}
\subsection{Question}
\label{sec:org9f4075f}
...
\label{sec:org67a5def}
\subsection{Text}
\label{sec:org636df66}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:orgaf7a3d0}
\subsection{Text}
\label{sec:org0d648f6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orga062669}
\subsection{Question}
\label{sec:orgbc84093}
...
\subsection{Answer}
\label{sec:org57fb170}
\subsubsection{Part 1}
\label{sec:org60dd7c2}
...
\label{sec:org244e036}
\subsection{Question}
\label{sec:orgdebd68c}
...
\label{sec:org0e5dde4}
\subsection{Text}
\label{sec:org0bb055d}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgb6bfb4e}
\subsection{Question}
\label{sec:orgcd5d799}
...
\label{sec:org3c5aba3}
\subsection{Question}
\label{sec:orgf36f7b9}
...
\label{sec:org3795c36}
\subsection{Question}
\label{sec:org94f2285}
...
\label{sec:orgf50ea4a}
\subsection{Question}
\label{sec:org6d7945e}
...
\label{sec:org6e2490b}
\subsection{Text}
\label{sec:org3b078b8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org15a54cd}
\subsection{Question}
\label{sec:orgb739b1a}
...
\label{sec:org3e2fc6f}
\subsection{Question A.1}
\label{sec:org50e6e5b}
...
\label{sec:org04f9d72}
\subsection{Question A}
\label{sec:orgc082ea4}
...
\label{sec:org49100b4}
\subsection{Question A}
\label{sec:org39112b1}
\index{filter}
...
\label{sec:org7735db8}
\subsection{Question}
\label{sec:org3f2d74b}
...
\label{sec:org613782f}
\subsection{Text}
\label{sec:orge7b373b}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org62d9bc9}
\subsection{Question}
\label{sec:orgd148cf9}
...
\label{sec:org631686b}
\subsection{Question A}
\label{sec:org5213580}
...
\label{sec:orga351b7f}
\subsection{Question}
\label{sec:orga779870}
...
\label{sec:org8d574e6}
\subsection{Question}
\label{sec:org4404276}
...
\label{sec:org8691067}
\subsection{Text}
\label{sec:org7597254}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org4d29158}
\subsection{Question}
\label{sec:org47f9408}
...
\label{sec:org3f0b777}
\subsection{Question}
\label{sec:orgcd2a0f3}
...
\label{sec:org41e3e58}
\subsection{Question}
\label{sec:org5bd1fa2}
...
\label{sec:org6e75288}
\subsection{Question}
\label{sec:org9df9a9d}
\index{smoothing}
