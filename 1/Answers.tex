...
\label{sec:orgf4a3de7}
\subsubsection*{\texttt{try-these}}
\label{sec:orgdb5a47c}
...
\label{sec:org06c13b5}
\subsection{Question}
\label{sec:org3683c86}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:org9e34b01}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:org71e3ff5}
\subsection{Question}
\label{sec:org54cceaf}
...
\label{sec:orgcb996ab}
\subsection{Text}
\label{sec:org55541a7}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:orgdfb40d7}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:org47de84a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org076c1b6}
\subsection{Question}
\label{sec:org451ad71}
...
\label{sec:orgb8e95f0}
\subsection{Question}
\label{sec:orge0fdf2a}
...
\label{sec:orgfc37490}
\subsection{Text code}
\label{sec:org240cf15}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:org9bbfbdd}
\subsection{Text}
\label{sec:orgfb869e6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:org39bd08f}
...
\subsection{Diary}
\label{sec:org906ac30}
\subsubsection{Solving}
\label{sec:org161ac70}
...
\label{sec:orgaebd8d7}
\begin{enumerate}
\item Non-optimized
\label{sec:org3d85553}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:org68822ab}
\subsection{Question}
\label{sec:org4f6e0cc}
...
\label{sec:orgfd5286e}
\subsection{Question}
\label{sec:orgdd8c1d1}
...
\label{sec:org7b51528}
\subsection{Question}
\label{sec:orgc282e15}
...
\subsection{Answer}
\label{sec:orgd6ef6f6}
\subsubsection{\texttt{f}}
\label{sec:org969b474}
...
\label{sec:org10c2bfc}
\subsection{Question}
\label{sec:org1edcb47}
...
\subsection{Answer}
\label{sec:orgbe35d59}
\subsubsection{Recursive}
\label{sec:orgcff197a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org1c1b615}
\begin{enumerate}
\item Attempt 1
\label{sec:orged9e6ac}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org583a8ec}
\subsection{Question}
\label{sec:org3e76e8c}
...
\label{sec:org6f7e26b}
\subsection{Question}
\label{sec:org4bc4623}
...
\label{sec:org372fed7}
\subsection{Question A}
\label{sec:orge6484f7}
...
\label{sec:org635f834}
\subsection{Text}
\label{sec:org7f943e8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org212fb67}
\subsection{Question}
\label{sec:org050e57b}
...
\label{sec:orgf5dd3fd}
\subsection{Question}
\label{sec:orgc2f664c}
Using the results of \hyperref[sec:org635f834]{Exercise 1.16} and \hyperref[sec:org212fb67]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:orgd6f5614}
\subsubsection{Comparison benchmarks:}
\label{sec:orgae1f48d}
...
\label{sec:orgb12c8f6}
\subsection{Question}
\label{sec:orgef06e6f}
...
\label{sec:org4dc2434}
\subsection{Text}
\label{sec:org5ea0d56}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org94492f4}
\subsection{Text}
\label{sec:orgd3df52c}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgb717b37}
\subsection{Question}
\label{sec:org96f4a9f}
...
\subsection{Answer}
\label{sec:orgb26bc87}
\subsubsection{Part 1}
\label{sec:org03ec6ea}
...
\label{sec:orgf0d4687}
\subsection{Question}
\label{sec:orgae30d1c}
...
\label{sec:org54ca37f}
\subsection{Text}
\label{sec:org6c250e2}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org3da3117}
\subsection{Question}
\label{sec:org48a1430}
...
\label{sec:org1181ec1}
\subsection{Question}
\label{sec:orgb180cdb}
...
\label{sec:orgc947ad2}
\subsection{Question}
\label{sec:orge79acfe}
...
\label{sec:org508c291}
\subsection{Question}
\label{sec:orgbc531c9}
...
\label{sec:orge452c57}
\subsection{Text}
\label{sec:org00a2b0a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org6bb0eed}
\subsection{Question}
\label{sec:org16fc3e6}
...
\label{sec:org59cf782}
\subsection{Question A.1}
\label{sec:org0ca9b8b}
...
\label{sec:org4ca5898}
\subsection{Question A}
\label{sec:org8f8c22b}
...
\label{sec:org17d97c7}
\subsection{Question A}
\label{sec:orgc10435b}
\index{filter}
...
\label{sec:org0d46f89}
\subsection{Question}
\label{sec:org1075ca5}
...
\label{sec:orgc9efc7f}
\subsection{Text}
\label{sec:org8687a5b}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org138f7f9}
\subsection{Question}
\label{sec:orgaece696}
...
\label{sec:orged136cb}
\subsection{Question A}
\label{sec:org72c8792}
