...
\label{sec:org30a50a6}
\subsubsection*{\texttt{try-these}}
\label{sec:orga75639c}
...
\label{sec:orga134d42}
\subsection{Question}
\label{sec:orgb25d837}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:org6bae6ae}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:orgfed2ad1}
\subsection{Question}
\label{sec:org92142e7}
...
\label{sec:orgc6d1edd}
\subsection{Text}
\label{sec:orgdb34a28}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:orgaecb35b}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:orgd078f31}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgf3f2bb2}
\subsection{Question}
\label{sec:orga7cb76b}
...
\label{sec:orga6f2282}
\subsection{Question}
\label{sec:org7f9b8fc}
...
\label{sec:orgb2b7b61}
\subsection{Text code}
\label{sec:orgab17205}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:org8e9ceb2}
\subsection{Text}
\label{sec:org00188dc}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:org1896657}
...
\subsection{Diary}
\label{sec:org62059d8}
\subsubsection{Solving}
\label{sec:org01d0fc4}
...
\label{sec:org4dc8bbd}
\begin{enumerate}
\item Non-optimized
\label{sec:org4439c28}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:orgc27998f}
\subsection{Question}
\label{sec:orgb7fbbb5}
...
\label{sec:org5a9f7b3}
\subsection{Question}
\label{sec:org8d42cb9}
...
\label{sec:orgdd2c0a8}
\subsection{Question}
\label{sec:org89e516b}
...
\subsection{Answer}
\label{sec:org0d66b59}
\subsubsection{\texttt{f}}
\label{sec:orgf2d4c80}
...
\label{sec:org496030c}
\subsection{Question}
\label{sec:org622284b}
...
\subsection{Answer}
\label{sec:orgad9d059}
\subsubsection{Recursive}
\label{sec:org5f3617a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org94d9531}
\subsection{Question}
\label{sec:org7f42b6d}
...
\label{sec:org9da5002}
\subsection{Question}
\label{sec:org15f333c}
...
\label{sec:orge772d2d}
\subsection{Question A}
\label{sec:orgec7543c}
...
\label{sec:orge8724c3}
\subsection{Text}
\label{sec:org795366f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org24ebd6e}
\subsection{Question}
\label{sec:org16b34ca}
...
\label{sec:org9ac5da9}
\subsection{Question}
\label{sec:orgd9806ce}
Using the results of \hyperref[sec:orge8724c3]{Exercise 1.16} and \hyperref[sec:org24ebd6e]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org66267e9}
\subsubsection{Comparison benchmarks:}
\label{sec:orge29a789}
...
\label{sec:orgbbcd7a2}
\subsection{Question}
\label{sec:org75d04c4}
...
\label{sec:org65458d9}
\subsection{Text}
\label{sec:org1e17f70}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org7e7e20c}
\subsection{Text}
\label{sec:org99f4835}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org0448f73}
\subsection{Question}
\label{sec:orgc46f0e0}
...
\subsection{Answer}
\label{sec:org30a3e45}
\subsubsection{Part 1}
\label{sec:orge1089fb}
...
\label{sec:orgbce8345}
\subsection{Question}
\label{sec:org9f3912c}
...
\label{sec:org39df387}
\subsection{Text}
\label{sec:org69f9efa}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgacc7ec2}
\subsection{Question}
\label{sec:orgdc3987b}
...
\label{sec:org8b6a816}
\subsection{Question}
\label{sec:org493cf03}
...
\label{sec:org7486a18}
\subsection{Question}
\label{sec:orgac2466d}
...
\label{sec:orgf9efeec}
\subsection{Question}
\label{sec:orgf5b8776}
...
\label{sec:org1a3f0d4}
\subsection{Text}
\label{sec:org33a7fb8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org80deaf6}
\subsection{Question}
\label{sec:org7f07dfa}
...
\label{sec:orga25a228}
\subsection{Question A.1}
\label{sec:org346a1ec}
...
\label{sec:orga1946d7}
\subsection{Question A}
\label{sec:org2adb3c1}
...
\label{sec:org515900b}
\subsection{Question A}
\label{sec:orgd84f71e}
\index{filter}
...
\label{sec:orge06ae7e}
\subsection{Question}
\label{sec:org84a983c}
...
\label{sec:orgd30a34e}
\subsection{Text}
\label{sec:org0c1110f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org3376e0a}
\subsection{Question}
\label{sec:org3459ef1}
...
\label{sec:org9362ff1}
\subsection{Question A}
\label{sec:orgeba33f9}
...
\label{sec:org8f54870}
\subsection{Question}
\label{sec:org05e48b2}
...
\label{sec:orgf121076}
\subsection{Question}
\label{sec:org40067eb}
...
\label{sec:org6e2cb0e}
\subsection{Text}
\label{sec:org2936b3b}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgc53a790}
\subsection{Question}
\label{sec:org9f76f56}
...
\label{sec:org3105faf}
\subsection{Question}
\label{sec:org72a82cc}
...
\label{sec:orgdb48549}
\subsection{Question}
\label{sec:org9c7b3de}
...
\label{sec:orge3a2510}
\subsection{Question}
\label{sec:org04c6d7b}
\index{smoothing}
