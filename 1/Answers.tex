...
\label{sec:org3906099}
\subsubsection{\texttt{try-these}}
\label{sec:org0188ec1}
...
\label{sec:org3b84650}
\subsection{Question}
\label{sec:org0a34acc}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:org80003a9}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:org64a54ff}
\subsection{Question}
\label{sec:org452217c}
...
\label{sec:orgc9c1c26}
\subsection{Text}
\label{sec:orgb5ce9a3}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:orgf96702d}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:orge74883f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org0b5321b}
\subsection{Question}
\label{sec:orgcd01422}
...
\label{sec:org47371e9}
\subsection{Text code}
\label{sec:orgf31a90a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:org41f8996}
\subsection{Text}
\label{sec:orgb361b40}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:org76f439a}
...
\subsection{Diary}
\label{sec:org16405ac}
\subsubsection{Solving}
\label{sec:orgb563cae}
...
\label{sec:org9a91029}
\begin{enumerate}
\item Non-optimized
\label{sec:org932d698}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:org36d6b09}
\subsection{Question}
\label{sec:org13f55e7}
...
\label{sec:orgecd49d4}
\subsection{Question}
\label{sec:orga9b1e99}
...
\label{sec:orgf7fa2fd}
\subsection{Question}
\label{sec:org3b44d7f}
...
\subsection{Answer}
\label{sec:orgc1c6525}
\subsubsection{\texttt{f}}
\label{sec:org7b82946}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<try-these>>
<<EX1-10-defs>>
...
\label{sec:org2711f50}
\subsection{Question}
\label{sec:org0421baa}
...
\subsection{Answer}
\label{sec:org8c9d8bb}
\subsubsection{Recursive}
\label{sec:orgc50cb15}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org7dba711}
\begin{enumerate}
\item Attempt 1
\label{sec:org292ee37}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orga02ccfd}
\subsection{Question}
\label{sec:org801bc7f}
...
\label{sec:org6d902a6}
\subsection{Question}
\label{sec:org58d5033}
...
\label{sec:org2fee3b1}
\subsection{Question 1}
\label{sec:org08cd018}
...
\label{sec:org3a1a405}
\subsection{Text}
\label{sec:org17c7c59}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:orge56f8b2}
\subsection{Question}
\label{sec:org1502389}
Using the results of \hyperref[sec:org3a1a405]{Exercise 1.16} and \hyperref[sec:orgba347ec]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:orgf1482fc}
\subsubsection{Comparison benchmarks:}
\label{sec:org5825ef6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(load "../mattbench.scm")
<<fast-mult-iter>>
<<fast-mult-rec>>
...
\label{sec:orge9fb2f4}
\subsection{Question}
\label{sec:org28e7f21}
...
\label{sec:org632c9d8}
\subsection{Text}
\label{sec:org35720f0}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org92d7fec}
\subsection{Text}
\label{sec:orge0e7638}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org743aa92}
\subsection{Question}
\label{sec:org9df02e3}
...
\subsection{Answer}
\label{sec:orgf0b1c9b}
\subsubsection{Part 1}
\label{sec:org503a2d2}
...
\label{sec:orga272ece}
\subsection{Question}
\label{sec:orgfe77074}
...
\label{sec:org95e035e}
\subsection{Text}
\label{sec:org4ef8d68}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
3686.3282 & 13351.8894 & 33088.8276 & 72938.5112 & 301546.52 & 685713.651 & 2072180.8884 & 7102494.7096 & 20348753.9118 & 61468319.545\\
239784.3956 & 331190.6826 & 400637.4218 & 472016.2916 & 647131.1474 & 673495.7498 & 713456.7276 & 3017270.7806 & 3983199.8268 & 4181357.7304\\
\end{tabular}
\end{table}
...
\label{sec:org352aeae}
\subsection{Question}
\label{sec:org57682bf}
...
exponentiations. \texttt{expmod} does the remainder after every exponentiation
operation, significantly reducing the memory requirements, as well as helping
with the other slowdowns associated with handling ``bignums''.
\end{document}
