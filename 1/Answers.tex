...
\label{sec:orga7d066b}
\subsubsection*{\texttt{try-these}}
\label{sec:orgced101e}
...
\label{sec:org1de1623}
\subsection{Question}
\label{sec:orgbae29bb}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:org509b6c9}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:org329b60c}
\subsection{Question}
\label{sec:orge6d9db5}
...
\label{sec:org68fb920}
\subsection{Text}
\label{sec:org4caba5c}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:org0a6c8d2}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:org13df121}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org4d61ecd}
\subsection{Question}
\label{sec:org9f19cda}
...
\label{sec:org8c531ab}
\subsection{Question}
\label{sec:org653c493}
...
\label{sec:org8886207}
\subsection{Text code}
\label{sec:org17a72c9}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:orgda1d999}
\subsection{Text}
\label{sec:org913b5c3}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:orgb7e4741}
...
\subsection{Diary}
\label{sec:orgdfa18cd}
\subsubsection{Solving}
\label{sec:org3226357}
...
\label{sec:org0718f63}
\begin{enumerate}
\item Non-optimized
\label{sec:orgef2c30b}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:orgc78f9bc}
\subsection{Question}
\label{sec:orgc992ed1}
...
\label{sec:org65cec81}
\subsection{Question}
\label{sec:orgc3ada57}
...
\label{sec:orgae22226}
\subsection{Question}
\label{sec:org0204702}
...
\subsection{Answer}
\label{sec:org1eff751}
\subsubsection{\texttt{f}}
\label{sec:org003fd9c}
...
\label{sec:org4e18bc6}
\subsection{Question}
\label{sec:orgcfcfa97}
...
\subsection{Answer}
\label{sec:org621dcde}
\subsubsection{Recursive}
\label{sec:orgbb62570}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org1f2a911}
\begin{enumerate}
\item Attempt 1
\label{sec:orge5ef6c6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org320464f}
\subsection{Question}
\label{sec:org56fc2d9}
...
\label{sec:org7626610}
\subsection{Question}
\label{sec:orgbcb50fc}
...
\label{sec:org73005e4}
\subsection{Question A}
\label{sec:orgf00b033}
...
\label{sec:org82df6d2}
\subsection{Text}
\label{sec:org53b4c2a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org8034a44}
\subsection{Question}
\label{sec:orgf655099}
...
\label{sec:org2b35f23}
\subsection{Question}
\label{sec:org44693ea}
Using the results of \hyperref[sec:org82df6d2]{Exercise 1.16} and \hyperref[sec:org8034a44]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org3552be7}
\subsubsection{Comparison benchmarks:}
\label{sec:orgbb43609}
...
\label{sec:orgee95652}
\subsection{Question}
\label{sec:org56782d4}
...
\label{sec:org5d2140c}
\subsection{Text}
\label{sec:org1dc48b8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:orgbf065d2}
\subsection{Text}
\label{sec:org948efa2}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org389b617}
\subsection{Question}
\label{sec:org3acee9a}
...
\subsection{Answer}
\label{sec:orgd198bcb}
\subsubsection{Part 1}
\label{sec:orgce1ce63}
...
\label{sec:org1a3fc91}
\subsection{Question}
\label{sec:org0cc4e4d}
...
\label{sec:org29e48c7}
\subsection{Text}
\label{sec:org62cfe9c}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgf55412b}
\subsection{Question}
\label{sec:org9fcd89a}
...
\label{sec:org0267b4c}
\subsection{Question}
\label{sec:orgf345940}
...
\label{sec:orgad7850d}
\subsection{Question}
\label{sec:org7e3354e}
...
\label{sec:orgc83cc5d}
\subsection{Question}
\label{sec:org69b742f}
...
\label{sec:org9501650}
\subsection{Text}
\label{sec:org5193841}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org6814dcb}
\subsection{Question}
\label{sec:org2a57f01}
...
\label{sec:org5fea0b4}
\subsection{Question A.1}
\label{sec:org8064355}
...
\label{sec:org6e2d96b}
\subsection{Question A}
\label{sec:org696c31e}
...
\label{sec:orgbb7d67d}
\subsection{Question A}
\label{sec:org4c12ddb}
\index{filter}
