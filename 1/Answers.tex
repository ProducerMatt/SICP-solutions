...
\label{sec:org2453c79}
\subsubsection*{\texttt{try-these}}
\label{sec:org419de23}
...
\label{sec:orgc7cb750}
\subsection{Question}
\label{sec:org5105ea9}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:org3d45598}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:org7d835e0}
\subsection{Question}
\label{sec:org2453ca2}
...
\label{sec:org8107443}
\subsection{Text}
\label{sec:org702b116}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:org8777ad3}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:orgb2f908d}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org1114c3f}
\subsection{Question}
\label{sec:org734f5db}
...
\label{sec:org73980b4}
\subsection{Question}
\label{sec:orgc970662}
...
\label{sec:orgb8710a6}
\subsection{Text code}
\label{sec:org4df936f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:orgb02d7ef}
\subsection{Text}
\label{sec:orgfbf423d}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:org1ed431d}
...
\subsection{Diary}
\label{sec:orgebbf8d7}
\subsubsection{Solving}
\label{sec:orge701732}
...
\label{sec:org16b725c}
\begin{enumerate}
\item Non-optimized
\label{sec:org7819efb}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:orgcad3a8c}
\subsection{Question}
\label{sec:org40a1122}
...
\label{sec:org96714ec}
\subsection{Question}
\label{sec:org4a7a284}
...
\label{sec:org24f6727}
\subsection{Question}
\label{sec:orgde03830}
...
\subsection{Answer}
\label{sec:orgf96b7c3}
\subsubsection{\texttt{f}}
\label{sec:orgaa6c1a8}
...
\label{sec:org1a79214}
\subsection{Question}
\label{sec:orge661c91}
...
\subsection{Answer}
\label{sec:org43715aa}
\subsubsection{Recursive}
\label{sec:org3561fa8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:orge4cd70d}
\begin{enumerate}
\item Attempt 1
\label{sec:orgabf262f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org3f46c1f}
\subsection{Question}
\label{sec:org7ad4919}
...
\label{sec:org7bca3ea}
\subsection{Question}
\label{sec:org4dce039}
...
\label{sec:org48a077c}
\subsection{Question A}
\label{sec:org9dbee8f}
...
\label{sec:org9203e52}
\subsection{Text}
\label{sec:org03074a8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org2d005fa}
\subsection{Question}
\label{sec:org86851c5}
...
\label{sec:orgd921514}
\subsection{Question}
\label{sec:org6a6c163}
Using the results of \hyperref[sec:org9203e52]{Exercise 1.16} and \hyperref[sec:org2d005fa]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org64c0ec3}
\subsubsection{Comparison benchmarks:}
\label{sec:orgb7d8598}
...
\label{sec:org7c2d616}
\subsection{Question}
\label{sec:orgf5f90b0}
...
\label{sec:org274b59d}
\subsection{Text}
\label{sec:org24ffdfa}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org4ee31ac}
\subsection{Text}
\label{sec:org17a3368}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgdf3f9c9}
\subsection{Question}
\label{sec:org39e57a3}
...
\subsection{Answer}
\label{sec:org3989b04}
\subsubsection{Part 1}
\label{sec:org4423411}
...
\label{sec:org49187ea}
\subsection{Question}
\label{sec:org581877c}
...
\label{sec:org1e2d6a4}
\subsection{Text}
\label{sec:orgc248d55}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgc43a71d}
\subsection{Question}
\label{sec:org5dd9f28}
...
\label{sec:orgb508283}
\subsection{Question}
\label{sec:orgb141718}
...
\label{sec:org0bf803b}
\subsection{Question}
\label{sec:org29f17da}
...
\label{sec:org1c29ae7}
\subsection{Question}
\label{sec:org30700d7}
...
\label{sec:org5adacaa}
\subsection{Text}
\label{sec:org075e76f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org695f450}
\subsection{Question}
\label{sec:orgc62636c}
...
\label{sec:org9e262a2}
\subsection{Question A.1}
\label{sec:orgaf4a0ee}
...
\label{sec:org54c8681}
\subsection{Question A}
\label{sec:orgf8b4390}
...
\label{sec:org65cbb0a}
\subsection{Question A}
\label{sec:org6832238}
\index{filter}
...
\label{sec:org910b055}
\subsection{Question}
\label{sec:orgd12532d}
...
\label{sec:orga0b7474}
\subsection{Text}
\label{sec:orgf306c7d}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org2ce5a0e}
\subsection{Question}
\label{sec:org79176fe}
...
\label{sec:orgc7cb7bb}
\subsection{Question A}
\label{sec:org2a6a3d5}
...
\label{sec:org18bb738}
\subsection{Question}
\label{sec:org145917d}
