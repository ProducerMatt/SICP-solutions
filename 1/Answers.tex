...
\label{sec:orgc8e996c}
\subsubsection*{\texttt{try-these}}
\label{sec:orgf8acc90}
...
\label{sec:org28ae7c7}
\subsection{Question}
\label{sec:orgd95ee58}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:orgb17ddad}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:orgc7f0bc4}
\subsection{Question}
\label{sec:orgb8e4c8d}
...
\label{sec:orgd228224}
\subsection{Text}
\label{sec:org9bf961f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:orgb0f86cb}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:orgd0f38ac}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgdc6a7c7}
\subsection{Question}
\label{sec:orge83132c}
...
\label{sec:orge7f6a10}
\subsection{Question}
\label{sec:org1430b77}
...
\label{sec:org680cb82}
\subsection{Text code}
\label{sec:org5b65db2}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:orgaaef009}
\subsection{Text}
\label{sec:orgb6f13c6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:orgee32158}
...
\subsection{Diary}
\label{sec:orgc22341a}
\subsubsection{Solving}
\label{sec:orge050276}
...
\label{sec:org93d5757}
\begin{enumerate}
\item Non-optimized
\label{sec:orgd8e1019}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:org6b2a595}
\subsection{Question}
\label{sec:orgfb0910e}
...
\label{sec:orgf2a7bb7}
\subsection{Question}
\label{sec:orgcb7cf8a}
...
\label{sec:org5dc6a5d}
\subsection{Question}
\label{sec:orge5c1963}
...
\subsection{Answer}
\label{sec:org368d510}
\subsubsection{\texttt{f}}
\label{sec:orge95f84f}
...
\label{sec:org2451211}
\subsection{Question}
\label{sec:org10d6cf3}
...
\subsection{Answer}
\label{sec:orgb3d1951}
\subsubsection{Recursive}
\label{sec:orgb8d03fc}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:orgef38f0e}
\begin{enumerate}
\item Attempt 1
\label{sec:org63aeedc}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org10449ad}
\subsection{Question}
\label{sec:orgb635131}
...
\label{sec:org6e50d94}
\subsection{Question}
\label{sec:orgc7878e8}
...
\label{sec:org7649cf9}
\subsection{Question A}
\label{sec:org2eadd7a}
...
\label{sec:org8bb469b}
\subsection{Text}
\label{sec:orgd1c5734}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:orgae1fd5d}
\subsection{Question}
\label{sec:org94e3bda}
...
\label{sec:orgbd64acb}
\subsection{Question}
\label{sec:org190ac23}
Using the results of \hyperref[sec:org8bb469b]{Exercise 1.16} and \hyperref[sec:orgae1fd5d]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:orga0dc13f}
\subsubsection{Comparison benchmarks:}
\label{sec:org2c38e4f}
...
\label{sec:org933e1ce}
\subsection{Question}
\label{sec:org8020544}
...
\label{sec:org324d824}
\subsection{Text}
\label{sec:org4c03fae}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org70d6477}
\subsection{Text}
\label{sec:org6c935a8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org274eded}
\subsection{Question}
\label{sec:org30b7917}
...
\subsection{Answer}
\label{sec:org0e9deba}
\subsubsection{Part 1}
\label{sec:org6c8202d}
...
\label{sec:orgdf71a17}
\subsection{Question}
\label{sec:org5136fd7}
...
\label{sec:org024e775}
\subsection{Text}
\label{sec:org9d7453f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org95b2881}
\subsection{Question}
\label{sec:org34a7aa8}
...
\label{sec:org4a4a478}
\subsection{Question}
\label{sec:org0feaa8b}
...
\label{sec:org6999c79}
\subsection{Question}
\label{sec:org9265f0d}
...
\label{sec:org87ce4f8}
\subsection{Question}
\label{sec:org61831d3}
...
\label{sec:org17271ea}
\subsection{Text}
\label{sec:org2c05265}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org9c1858b}
\subsection{Question}
\label{sec:org83155d5}
...
\label{sec:org7978c54}
\subsection{Question A.1}
\label{sec:org7e34b6e}
...
\label{sec:org98e9127}
\subsection{Question A}
\label{sec:org8c5321c}
\index{filter}
...
\label{sec:org602372a}
\subsection{Question}
\label{sec:orgd1b4a48}
...
\label{sec:orge7194e2}
\subsection{Text}
\label{sec:orga25847c}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org728b48e}
\subsection{Question}
\label{sec:org2ddb31f}
...
\label{sec:orgface6e6}
\subsection{Question A}
\label{sec:org91023d2}
...
\label{sec:org68f22ed}
\subsection{Question}
\label{sec:org48f7379}
...
\label{sec:orgbefa15e}
\subsection{Question}
\label{sec:orgd171ebd}
...
\label{sec:org4a10ea2}
\subsection{Text}
\label{sec:org54a2c60}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org5db14de}
\subsection{Question}
\label{sec:org6af96c0}
...
\label{sec:org4c9ef27}
\subsection{Question}
\label{sec:org71170b4}
...
\label{sec:org86f40ed}
\subsection{Question}
\label{sec:orgce2fefb}
...
\label{sec:org3e5b8b3}
\subsection{Question}
\label{sec:orga7c66cd}
\index{smoothing}
