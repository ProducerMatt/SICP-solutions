...
\label{sec:org78435a4}
\subsubsection{\texttt{try-these}}
\label{sec:orgb81c6cb}
...
\label{sec:org5c01dc5}
\subsection{Question}
\label{sec:orgc4f794c}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:orgf71222d}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:orgeb8af2c}
\subsection{Question}
\label{sec:org448fbdc}
...
\label{sec:org43fb20d}
\subsection{Text}
\label{sec:org90edc51}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:orgacc4604}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:org6eee954}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org9bb3d64}
\subsection{Question}
\label{sec:org4c058d4}
...
\label{sec:orgdc89f8d}
\subsection{Question}
\label{sec:org2fecfb9}
...
\label{sec:org74ab744}
\subsection{Text code}
\label{sec:orge8d91e6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:org150af2c}
\subsection{Text}
\label{sec:org0c832e7}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:org441663d}
...
\subsection{Diary}
\label{sec:org390be28}
\subsubsection{Solving}
\label{sec:orgb91fe4b}
...
\label{sec:org6faa0eb}
\begin{enumerate}
\item Non-optimized
\label{sec:orgff7a458}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org147874f}
\subsection{Question}
\label{sec:orgb4a1196}
...
\label{sec:orgf91b406}
\subsection{Question}
\label{sec:orgeda5aa9}
...
\label{sec:org93460ac}
\subsection{Question}
\label{sec:org21fc709}
...
\subsection{Answer}
\label{sec:org2b536ec}
\subsubsection{\texttt{f}}
\label{sec:org402c5aa}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<try-these>>
<<EX1-10-defs>>
...
\label{sec:org3ec44e2}
\subsection{Question}
\label{sec:org825455d}
...
\subsection{Answer}
\label{sec:org240a392}
\subsubsection{Recursive}
\label{sec:orgfd64dde}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org13392bb}
\begin{enumerate}
\item Attempt 1
\label{sec:org97469a5}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org471b246}
\subsection{Question}
\label{sec:org062b508}
...
\label{sec:orge0606ae}
\subsection{Question}
\label{sec:org40acdd1}
...
\label{sec:org52bf5a8}
\subsection{Question 1}
\label{sec:org99a3fdb}
...
\label{sec:org98bca63}
\subsection{Text}
\label{sec:orgcbfc27c}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org8970f70}
\subsection{Question}
\label{sec:orgd980b1e}
...
\label{sec:orgbddbf60}
\subsection{Question}
\label{sec:orgd91dce5}
Using the results of \hyperref[sec:org98bca63]{Exercise 1.16} and \hyperref[sec:org8970f70]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org8b73389}
\subsubsection{Comparison benchmarks:}
\label{sec:orgf398150}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(load "../mattbench.scm")
<<fast-mult-iter>>
<<fast-mult-rec>>
...
\label{sec:orgd984d8f}
\subsection{Question}
\label{sec:orga2c4e29}
...
\label{sec:org5be22db}
\subsection{Text}
\label{sec:orgf9cdfaa}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
