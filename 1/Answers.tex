...
\label{sec:orgd3eec6e}
\subsubsection*{\texttt{try-these}}
\label{sec:org9e3943d}
...
\label{sec:org308d491}
\subsection{Question}
\label{sec:org221953d}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:org634a1a0}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:orgbc0736c}
\subsection{Question}
\label{sec:org8f101dd}
...
\label{sec:org8334618}
\subsection{Text}
\label{sec:org8414d89}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:orga419f53}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:org5ac9522}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org903c47c}
\subsection{Question}
\label{sec:org62e93d6}
...
\label{sec:org4b7b181}
\subsection{Question}
\label{sec:org41fa935}
...
\label{sec:org78909bc}
\subsection{Text code}
\label{sec:orgaea5e2f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:orgc3043c3}
\subsection{Text}
\label{sec:org94ba59e}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:orgad2f8bb}
...
\subsection{Diary}
\label{sec:org4a6f551}
\subsubsection{Solving}
\label{sec:org0ed6eed}
...
\label{sec:org9eb56f7}
\begin{enumerate}
\item Non-optimized
\label{sec:org87545f7}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:org13e5550}
\subsection{Question}
\label{sec:org459ebc2}
...
\label{sec:org438abdb}
\subsection{Question}
\label{sec:org97ce193}
...
\label{sec:org101ed6d}
\subsection{Question}
\label{sec:org5b97335}
...
\subsection{Answer}
\label{sec:orgeee46f6}
\subsubsection{\texttt{f}}
\label{sec:org4cb3159}
...
\label{sec:orgd47df1d}
\subsection{Question}
\label{sec:orge6f4e90}
...
\subsection{Answer}
\label{sec:org171f268}
\subsubsection{Recursive}
\label{sec:orgead7567}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:orge2bcfb6}
\begin{enumerate}
\item Attempt 1
\label{sec:orgf081fa3}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org97129d0}
\subsection{Question}
\label{sec:org4d35d2e}
...
\label{sec:org172e8d9}
\subsection{Question}
\label{sec:org5e9b78a}
...
\label{sec:orgb8e473c}
\subsection{Question A}
\label{sec:org50c4a7d}
...
\label{sec:org55249d6}
\subsection{Text}
\label{sec:org3bc13d0}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org5ed4f7f}
\subsection{Question}
\label{sec:orga2bea49}
...
\label{sec:org9eb7d76}
\subsection{Question}
\label{sec:orga4f8e7e}
Using the results of \hyperref[sec:org55249d6]{Exercise 1.16} and \hyperref[sec:org5ed4f7f]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org2cfa2eb}
\subsubsection{Comparison benchmarks:}
\label{sec:org74122a2}
...
\label{sec:org16b723d}
\subsection{Question}
\label{sec:org03264ab}
...
\label{sec:org53d5c01}
\subsection{Text}
\label{sec:orga10bc93}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org5c38ee7}
\subsection{Question}
\label{sec:org1ad246c}
...
\subsection{Answer}
\label{sec:org7310f22}
\subsubsection{Part 1}
\label{sec:orgf2b25ce}
...
\label{sec:orgc56aa99}
\subsection{Question}
\label{sec:org261e685}
...
\label{sec:org18a9f41}
\subsection{Text}
\label{sec:org6c842a7}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgc2b1494}
\subsection{Question}
\label{sec:org3ff326e}
...
\label{sec:org72c32b7}
\subsection{Question}
\label{sec:org3597fa7}
...
\label{sec:org06b4a6d}
\subsection{Question}
\label{sec:orgf6ccd31}
...
\label{sec:org9e7e5bc}
\subsection{Question}
\label{sec:org8374049}
...
\label{sec:org5f9bd6e}
\subsection{Text}
\label{sec:org71445d6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org20a3dbb}
\subsection{Question}
\label{sec:org5569eaf}
...
\label{sec:org5eb6c2a}
\subsection{Question A.1}
\label{sec:org3232bde}
...
\label{sec:org73a4d86}
\subsection{Question A}
\label{sec:org21a669b}
