...
\label{sec:org7ad33ad}
\subsubsection{\texttt{try-these}}
\label{sec:orga9b8c0c}
...
\label{sec:org237cfce}
\subsection{Question}
\label{sec:org32f5466}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:org7ce40a1}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:orga71a3ca}
\subsection{Question}
\label{sec:org2ea89c5}
...
\label{sec:org568a3a6}
\subsection{Text}
\label{sec:orgf6ea23f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:orgda54a2e}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:org37cd384}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org29d95a8}
\subsection{Question}
\label{sec:orgfea4024}
...
\label{sec:org161aefa}
\subsection{Question}
\label{sec:orgfce6425}
...
\label{sec:org5025dd4}
\subsection{Text code}
\label{sec:orge757da0}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:org28e89d2}
\subsection{Text}
\label{sec:org2b9ec37}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:orgd9d9099}
...
\subsection{Diary}
\label{sec:orgbd3bacc}
\subsubsection{Solving}
\label{sec:orgbb93225}
...
\label{sec:org3c93afb}
\begin{enumerate}
\item Non-optimized
\label{sec:org935f1b7}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:orgfd44aef}
\subsection{Question}
\label{sec:orgc9210c6}
...
\label{sec:org8c80e07}
\subsection{Question}
\label{sec:orgf0d71a5}
...
\label{sec:org2608e82}
\subsection{Question}
\label{sec:org7fba180}
...
\subsection{Answer}
\label{sec:orgec1511c}
\subsubsection{\texttt{f}}
\label{sec:org85ecc9a}
...
\label{sec:org021d70d}
\subsection{Question}
\label{sec:org6c3f417}
...
\subsection{Answer}
\label{sec:orga914b82}
\subsubsection{Recursive}
\label{sec:org4540603}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org29ef28a}
\begin{enumerate}
\item Attempt 1
\label{sec:orgb19428a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org9c731c9}
\subsection{Question}
\label{sec:org1fd8ae6}
...
\label{sec:orge609cbc}
\subsection{Question}
\label{sec:orgeac7327}
...
\label{sec:org915ae38}
\subsection{Question 1}
\label{sec:orgf6cee47}
...
\label{sec:orgb7447d8}
\subsection{Text}
\label{sec:org4db2b1a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org5a6a5d1}
\subsection{Question}
\label{sec:org3f5cf6c}
...
\label{sec:org202d707}
\subsection{Question}
\label{sec:orgb6b8ea7}
Using the results of \hyperref[sec:orgb7447d8]{Exercise 1.16} and \hyperref[sec:org5a6a5d1]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:orgfbe07f7}
\subsubsection{Comparison benchmarks:}
\label{sec:org3635805}
...
\label{sec:org58ff0a2}
\subsection{Question}
\label{sec:org6899ba9}
...
\label{sec:orgbfc8a22}
\subsection{Text}
\label{sec:orgf918d69}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org188d4e4}
\subsection{Text}
\label{sec:org6150f88}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org4f0edfb}
\subsection{Question}
\label{sec:orga47edd4}
...
\subsection{Answer}
\label{sec:org102a497}
\subsubsection{Part 1}
\label{sec:orgaf5cfd0}
...
\label{sec:orgb4cee30}
\subsection{Question}
\label{sec:org2df35c5}
...
\label{sec:orgf9a5bbc}
\subsection{Text}
\label{sec:orgfb61495}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org110c83e}
\subsection{Question}
\label{sec:org93b3ddc}
...
\label{sec:org21a55e2}
\subsection{Question}
\label{sec:orgbaa1551}
...
\label{sec:org0fd9e8e}
\subsection{Question}
\label{sec:org5a8d02b}
...
\label{sec:org3e020c9}
\subsection{Question}
\label{sec:org367a9e7}
