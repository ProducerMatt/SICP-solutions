...
\label{sec:orge465ffb}
\subsubsection*{\texttt{try-these}}
\label{sec:org68aa600}
...
\label{sec:orgdcf28a1}
\subsection{Question}
\label{sec:org4182ce1}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:org424b5c3}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:org6ea5369}
\subsection{Question}
\label{sec:org01910a6}
...
\label{sec:org366af2b}
\subsection{Text}
\label{sec:orgfa89171}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:org0035df5}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:org11b0bdf}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgf60b0f1}
\subsection{Question}
\label{sec:orged919ec}
...
\label{sec:org24d0671}
\subsection{Question}
\label{sec:orgb01f794}
...
\label{sec:org0376a73}
\subsection{Text code}
\label{sec:org2452496}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:org8564fcd}
\subsection{Text}
\label{sec:org16aa2c9}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:org063c654}
...
\subsection{Diary}
\label{sec:org608e045}
\subsubsection{Solving}
\label{sec:orgd091862}
...
\label{sec:org26b6090}
\begin{enumerate}
\item Non-optimized
\label{sec:org3df133d}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:org6053014}
\subsection{Question}
\label{sec:org126a578}
...
\label{sec:org8d94d86}
\subsection{Question}
\label{sec:orge6ac790}
...
\label{sec:org280c80a}
\subsection{Question}
\label{sec:org93ed948}
...
\subsection{Answer}
\label{sec:orgc8f3827}
\subsubsection{\texttt{f}}
\label{sec:orga56376d}
...
\label{sec:org8bd0b01}
\subsection{Question}
\label{sec:org4d22382}
...
\subsection{Answer}
\label{sec:org6cda38c}
\subsubsection{Recursive}
\label{sec:orga2fb439}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org128c746}
\begin{enumerate}
\item Attempt 1
\label{sec:orgac829df}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org683aa6b}
\subsection{Question}
\label{sec:orgccd4d64}
...
\label{sec:org22a8e16}
\subsection{Question}
\label{sec:orgc1432d4}
...
\label{sec:orga857132}
\subsection{Question A}
\label{sec:org9027301}
...
\label{sec:orgd68cc48}
\subsection{Text}
\label{sec:org6ddc77a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:orgda8269d}
\subsection{Question}
\label{sec:orgbacd7a5}
...
\label{sec:org14bd687}
\subsection{Question}
\label{sec:org86a0909}
Using the results of \hyperref[sec:orgd68cc48]{Exercise 1.16} and \hyperref[sec:orgda8269d]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org99b669b}
\subsubsection{Comparison benchmarks:}
\label{sec:org8e0f200}
...
\label{sec:org03dc55f}
\subsection{Question}
\label{sec:orgb54904b}
...
\label{sec:org42c3b4e}
\subsection{Text}
\label{sec:org802eec4}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:orgf8f3572}
\subsection{Text}
\label{sec:orgab116d6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org34eec6e}
\subsection{Question}
\label{sec:org313bd74}
...
\subsection{Answer}
\label{sec:orgbccf1de}
\subsubsection{Part 1}
\label{sec:orgc936ffa}
...
\label{sec:orgdf5286b}
\subsection{Question}
\label{sec:org6eb0a91}
...
\label{sec:org2332d65}
\subsection{Text}
\label{sec:orgbcc53e8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org0b2e5d8}
\subsection{Question}
\label{sec:orgf4f4269}
...
\label{sec:org0ede922}
\subsection{Question}
\label{sec:org972a294}
...
\label{sec:org8d4f940}
\subsection{Question}
\label{sec:orgb48688a}
...
\label{sec:org0f5a24e}
\subsection{Question}
\label{sec:org3565347}
...
\label{sec:orgf9f8a31}
\subsection{Text}
\label{sec:orgc08e11d}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orge40ed4d}
\subsection{Question}
\label{sec:org2143e9d}
...
\label{sec:orgb564a9e}
\subsection{Question A.1}
\label{sec:orgd11026b}
...
\label{sec:orgb8cb15d}
\subsection{Question A}
\label{sec:org684de04}
...
\label{sec:orgc046992}
\subsection{Question A}
\label{sec:org329a4ad}
\index{filter}
...
\label{sec:orgebd1d1e}
\subsection{Question}
\label{sec:org1bdc759}
...
\label{sec:orgb89e6e3}
\subsection{Text}
\label{sec:org0231dd8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgc43c352}
\subsection{Question}
\label{sec:org24e08a9}
...
\label{sec:orgc4f4857}
\subsection{Question A}
\label{sec:org4587eb6}
...
\label{sec:org5b3999e}
\subsection{Question}
\label{sec:org9e361c6}
...
\label{sec:orgbb0c52d}
\subsection{Question}
\label{sec:org62c1a9a}
...
\label{sec:orgd49d480}
\subsection{Text}
\label{sec:org719c2a0}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org784f485}
\subsection{Question}
\label{sec:orgce98b91}
