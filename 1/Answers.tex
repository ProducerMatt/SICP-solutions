...
\label{sec:orge4d3924}
\subsubsection{\texttt{try-these}}
\label{sec:org0d3dd8d}
...
\label{sec:org79067b8}
\subsection{Question}
\label{sec:org1ebe4ba}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:org24c0fa5}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:org20fc4c8}
\subsection{Question}
\label{sec:orgbfa62d2}
...
\label{sec:orgd09120c}
\subsection{Text}
\label{sec:org929b649}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:org50881ed}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:orgbb27174}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgbf62cab}
\subsection{Question}
\label{sec:org19082d1}
...
\label{sec:org2c479b3}
\subsection{Question}
\label{sec:orgf55b8d8}
...
\label{sec:org0b6acd6}
\subsection{Text code}
\label{sec:org981659d}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:org00d8ac4}
\subsection{Text}
\label{sec:org8606b3a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:org81f14e1}
...
\subsection{Diary}
\label{sec:org7d6288b}
\subsubsection{Solving}
\label{sec:orgbe85279}
...
\label{sec:org534e6d6}
\begin{enumerate}
\item Non-optimized
\label{sec:org8f37dbc}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:org2a2532a}
\subsection{Question}
\label{sec:org08ed251}
...
\label{sec:org01a6c82}
\subsection{Question}
\label{sec:orgbbf9562}
...
\label{sec:org114d73c}
\subsection{Question}
\label{sec:orgf864941}
...
\subsection{Answer}
\label{sec:org9486347}
\subsubsection{\texttt{f}}
\label{sec:org12a0708}
...
\label{sec:org18764a5}
\subsection{Question}
\label{sec:orga2e5650}
...
\subsection{Answer}
\label{sec:org7a1ad28}
\subsubsection{Recursive}
\label{sec:orgb4f7ea5}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org8d5c74e}
\begin{enumerate}
\item Attempt 1
\label{sec:org10e4805}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org913c4a9}
\subsection{Question}
\label{sec:orgbd9b9b2}
...
\label{sec:org031d15f}
\subsection{Question}
\label{sec:org85aaa71}
...
\label{sec:orgb73eecc}
\subsection{Question 1}
\label{sec:org171642d}
...
\label{sec:org0055d2e}
\subsection{Text}
\label{sec:orgb931d48}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:orgd8d45d7}
\subsection{Question}
\label{sec:org6750f13}
...
\label{sec:orge4c8e5a}
\subsection{Question}
\label{sec:orgfd2f2cc}
Using the results of \hyperref[sec:org0055d2e]{Exercise 1.16} and \hyperref[sec:orgd8d45d7]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org7fcff8a}
\subsubsection{Comparison benchmarks:}
\label{sec:org6c2ee45}
...
\label{sec:org2157a0b}
\subsection{Question}
\label{sec:orgf640f68}
...
\label{sec:orgd5377ad}
\subsection{Text}
\label{sec:org34fa003}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:orgac8a399}
\subsection{Text}
\label{sec:orge2f408d}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org01ab27c}
\subsection{Question}
\label{sec:org38290fa}
...
\subsection{Answer}
\label{sec:org189c5a7}
\subsubsection{Part 1}
\label{sec:orgb3370c1}
...
\label{sec:org5454480}
\subsection{Question}
\label{sec:orge452495}
...
\label{sec:org29821b9}
\subsection{Text}
\label{sec:org36c3189}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgf923f6a}
\subsection{Question}
\label{sec:org3760ca3}
...
\label{sec:org3866b5d}
\subsection{Question}
\label{sec:org7bf136b}
...
\label{sec:org670d18e}
\subsection{Question}
\label{sec:org2b10d5c}
...
\label{sec:org4b448df}
\subsection{Question}
\label{sec:org88c8056}
...
\label{sec:org1f3ce68}
\subsection{Question}
\label{sec:orgb90a50c}
...
using Simpson's Rule.  Use your procedure to integrate \texttt{cube} between 0
and 1 (with \(n = 100\) and \(n = 1000\)), and compare the results to those of
the \texttt{integral} procedure shown above.
\end{document}
