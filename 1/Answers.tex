...
\label{sec:orgd6329a4}
\subsubsection*{\texttt{try-these}}
\label{sec:org5c4b64e}
...
\label{sec:org53971d4}
\subsection{Question}
\label{sec:orgc166763}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:org49ccd43}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:orgbe9c131}
\subsection{Question}
\label{sec:org1fe4e5b}
...
\label{sec:org09d513c}
\subsection{Text}
\label{sec:orgae2cd22}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:org4ec2273}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:org1b0eb73}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org8c1bfd6}
\subsection{Question}
\label{sec:orgd14e521}
...
\label{sec:org1bcf327}
\subsection{Question}
\label{sec:orgef3ff38}
...
\label{sec:org3995a1f}
\subsection{Text code}
\label{sec:org6d4ee34}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:orgd04b4be}
\subsection{Text}
\label{sec:org5862fb7}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:org89dfa92}
...
\subsection{Diary}
\label{sec:org1bf421e}
\subsubsection{Solving}
\label{sec:org1241084}
...
\label{sec:orgc0d7e60}
\begin{enumerate}
\item Non-optimized
\label{sec:orgee8c0d7}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:org2269ab9}
\subsection{Question}
\label{sec:orge78f135}
...
\label{sec:org54d169a}
\subsection{Question}
\label{sec:org658746b}
...
\label{sec:org67fd632}
\subsection{Question}
\label{sec:org1a5a92d}
...
\subsection{Answer}
\label{sec:org828da86}
\subsubsection{\texttt{f}}
\label{sec:org0d83739}
...
\label{sec:org6d7d2f1}
\subsection{Question}
\label{sec:org0067435}
...
\subsection{Answer}
\label{sec:org82577b2}
\subsubsection{Recursive}
\label{sec:org43bfdca}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org324b32b}
\begin{enumerate}
\item Attempt 1
\label{sec:org2d0b108}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgdcde64c}
\subsection{Question}
\label{sec:orga64d741}
...
\label{sec:org5b61376}
\subsection{Question}
\label{sec:org156abb9}
...
\label{sec:org2c9d03a}
\subsection{Question A}
\label{sec:orgadc5fd9}
...
\label{sec:org2a92ebc}
\subsection{Text}
\label{sec:orgb5dd81b}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org803c959}
\subsection{Question}
\label{sec:org8895e4f}
...
\label{sec:org907ec30}
\subsection{Question}
\label{sec:orgaf612a9}
Using the results of \hyperref[sec:org2a92ebc]{Exercise 1.16} and \hyperref[sec:org803c959]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org11563a2}
\subsubsection{Comparison benchmarks:}
\label{sec:orgbdc1581}
...
\label{sec:orgf6e6791}
\subsection{Question}
\label{sec:org1e74a01}
...
\label{sec:org88cc1f5}
\subsection{Text}
\label{sec:orga8072c1}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org594bbab}
\subsection{Text}
\label{sec:orgf115b04}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgf548e4c}
\subsection{Question}
\label{sec:org27a7b77}
...
\subsection{Answer}
\label{sec:org72e1f04}
\subsubsection{Part 1}
\label{sec:orge11d0a3}
...
\label{sec:org6aed109}
\subsection{Question}
\label{sec:org2fbf4f8}
...
\label{sec:org7b24dad}
\subsection{Text}
\label{sec:orge3a6a97}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org029ce05}
\subsection{Question}
\label{sec:orgba7af57}
...
\label{sec:orgb7e90b9}
\subsection{Question}
\label{sec:org336d433}
...
\label{sec:orgb112532}
\subsection{Question}
\label{sec:org6a85dca}
...
\label{sec:orgcd10f5c}
\subsection{Question}
\label{sec:org54b7cf3}
...
\label{sec:org9f7975a}
\subsection{Text}
\label{sec:orga478854}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org58da205}
\subsection{Question}
\label{sec:org1cd3d1f}
...
\label{sec:org39e1c19}
\subsection{Question A.1}
\label{sec:org98cece7}
...
\label{sec:org3b6393f}
\subsection{Question A}
\label{sec:orgd9991dc}
...
\label{sec:org38bfd72}
\subsection{Question}
\label{sec:orgb02a3a7}
...
\label{sec:org8048b5e}
\subsection{Text}
\label{sec:orgaada2e0}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org7e29ebf}
\subsection{Question}
\label{sec:org2680899}
...
\label{sec:org5af6dc0}
\subsection{Question A}
\label{sec:org24e690e}
...
\label{sec:org10f1452}
\subsection{Question}
\label{sec:org553f18e}
...
\label{sec:org769b017}
\subsection{Question}
\label{sec:org0a2df2d}
...
\label{sec:org4665d3a}
\subsection{Text}
\label{sec:org2d22b7b}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orga1d9395}
\subsection{Question}
\label{sec:org40dfbe8}
...
\label{sec:org4cf6143}
\subsection{Question}
\label{sec:org4c46a33}
...
\label{sec:orgc2e4de5}
\subsection{Question}
\label{sec:org993bac3}
...
\label{sec:org177de17}
\subsection{Question}
\label{sec:orga87bafd}
\index{smoothing}
...
\label{sec:org8a7ccaf}
\subsection{Question}
\label{sec:org031d143}
...
\label{sec:org66d36c9}
\subsection{Question}
\label{sec:orgb78a4fe}
