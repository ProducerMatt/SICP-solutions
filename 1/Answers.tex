...
\label{sec:org8d6ef66}
\subsubsection{\texttt{try-these}}
\label{sec:orgfe8c43c}
...
\label{sec:org9e8e34f}
\subsection{Question}
\label{sec:org622ee01}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:orgf9ea85c}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:orgc5454b1}
\subsection{Question}
\label{sec:org8061995}
...
\label{sec:orgec2d5ce}
\subsection{Text}
\label{sec:org9905b10}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:org0885722}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:orgb45ce49}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgdb601e7}
\subsection{Question}
\label{sec:org1179147}
...
\label{sec:org77a2e1a}
\subsection{Question}
\label{sec:orgc24c937}
...
\label{sec:org10779a0}
\subsection{Text code}
\label{sec:org4329d91}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:org410fbd3}
\subsection{Text}
\label{sec:org0ba02e9}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:orgcb0f8ba}
...
\subsection{Diary}
\label{sec:orgcbed6fc}
\subsubsection{Solving}
\label{sec:org954bd2e}
...
\label{sec:orge3dffc2}
\begin{enumerate}
\item Non-optimized
\label{sec:org9900dd6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org56fbd80}
\subsection{Question}
\label{sec:orge7ab3ba}
...
\label{sec:org1b278f6}
\subsection{Question}
\label{sec:org9a2ef78}
...
\label{sec:org775d87c}
\subsection{Question}
\label{sec:org196a194}
...
\subsection{Answer}
\label{sec:orga964ca9}
\subsubsection{\texttt{f}}
\label{sec:orge2eb2d8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<try-these>>
<<EX1-10-defs>>
...
\label{sec:orgc8a0b93}
\subsection{Question}
\label{sec:orga36b635}
...
\subsection{Answer}
\label{sec:orgd8d5d74}
\subsubsection{Recursive}
\label{sec:orgd6b46b4}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org3befc6a}
\begin{enumerate}
\item Attempt 1
\label{sec:orgff1cfbd}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org56b9f73}
\subsection{Question}
\label{sec:orgeed0e24}
...
\label{sec:orge09cef3}
\subsection{Question}
\label{sec:org986f36b}
...
\label{sec:orgc344f9b}
\subsection{Question 1}
\label{sec:org20aef45}
...
\label{sec:org43a0404}
\subsection{Text}
\label{sec:org0b5a339}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org42ed17c}
\subsection{Question}
\label{sec:orgb3e32b1}
...
\label{sec:org132f1f5}
\subsection{Question}
\label{sec:org8b893b4}
Using the results of \hyperref[sec:org43a0404]{Exercise 1.16} and \hyperref[sec:org42ed17c]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org692e253}
\subsubsection{Comparison benchmarks:}
\label{sec:orge90a061}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(load "../mattbench.scm")
<<fast-mult-iter>>
<<fast-mult-rec>>
...
\label{sec:org4efaf47}
\subsection{Question}
\label{sec:org97cb0ca}
...
And in the case of my higher-level function I write later:
\[
