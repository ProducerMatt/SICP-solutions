...
\label{sec:org72de721}
\subsubsection{\texttt{try-these}}
\label{sec:org5b10619}
...
\label{sec:org3cb8cd0}
\subsection{Question}
\label{sec:org053e002}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:orgf2ba37e}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:org8161547}
\subsection{Question}
\label{sec:org4f01ed9}
...
\label{sec:org8c7eb7d}
\subsection{Text}
\label{sec:org87d2afa}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:orgac4c12e}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:orgb64525c}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgb7071fa}
\subsection{Question}
\label{sec:orged02673}
...
\label{sec:orgdf11501}
\subsection{Question}
\label{sec:orga02484c}
...
\label{sec:org78813bf}
\subsection{Text code}
\label{sec:orga3b9b28}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:org672db4e}
\subsection{Text}
\label{sec:orge7a56ed}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:org2462b86}
...
\subsection{Diary}
\label{sec:orgd694978}
\subsubsection{Solving}
\label{sec:orgd89cbc0}
...
\label{sec:orgfc467e0}
\begin{enumerate}
\item Non-optimized
\label{sec:org2a7a5e2}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:org072a0ab}
\subsection{Question}
\label{sec:org97077fb}
...
\label{sec:org51bda71}
\subsection{Question}
\label{sec:org9b82ed8}
...
\label{sec:org8808e1e}
\subsection{Question}
\label{sec:org1d7b573}
...
\subsection{Answer}
\label{sec:org2948b35}
\subsubsection{\texttt{f}}
\label{sec:org9048a12}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<try-these>>
<<EX1-10-defs>>
...
\label{sec:org2bfcb00}
\subsection{Question}
\label{sec:orgc31d6fd}
...
\subsection{Answer}
\label{sec:orga2712c5}
\subsubsection{Recursive}
\label{sec:org0978f9d}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org22279f6}
\begin{enumerate}
\item Attempt 1
\label{sec:orgb81a9e0}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org0fd76d6}
\subsection{Question}
\label{sec:org06fa836}
...
\label{sec:orgd036f07}
\subsection{Question}
\label{sec:org8a22df0}
...
\label{sec:org76aeeae}
\subsection{Question 1}
\label{sec:org17a8379}
...
\label{sec:orgd2f668f}
\subsection{Text}
\label{sec:org6f876d6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org9109560}
\subsection{Question}
\label{sec:orgbe83bbd}
...
\label{sec:orgc3fbb9b}
\subsection{Question}
\label{sec:org3248954}
Using the results of \hyperref[sec:orgd2f668f]{Exercise 1.16} and \hyperref[sec:org9109560]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org9234fd6}
\subsubsection{Comparison benchmarks:}
\label{sec:org4d99b45}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(load "../mattbench.scm")
<<fast-mult-iter>>
<<fast-mult-rec>>
...
\label{sec:org5ee335e}
\subsection{Question}
\label{sec:org0381ef0}
...
\label{sec:orgb2d5d71}
\subsection{Text}
\label{sec:orgb99c8f2}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org900751f}
\subsection{Text}
\label{sec:org534f8dd}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org6f76beb}
\subsection{Question}
\label{sec:org435ab9c}
...
\subsection{Answer}
\label{sec:orgc562663}
\subsubsection{Part 1}
\label{sec:org129a37c}
...
\label{sec:orgebe4beb}
\subsection{Question}
\label{sec:org644787a}
