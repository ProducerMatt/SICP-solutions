...
\label{sec:orgcda0cee}
\subsubsection{\texttt{try-these}}
\label{sec:orge6410a7}
...
\label{sec:orgf067d92}
\subsection{Question}
\label{sec:orge8ed7a8}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:orgc5969f9}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:orgc869d66}
\subsection{Question}
\label{sec:org3cd1849}
...
\label{sec:org7afd376}
\subsection{Text}
\label{sec:org87159c3}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
\subsection{Question}
\label{sec:orgf249897}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\subsection{Answer}
\label{sec:orgb322640}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orge33e4e4}
\subsection{Question}
\label{sec:org2fbed1a}
...
\label{sec:orga3d3509}
\subsection{Question}
\label{sec:org1dd7ca7}
...
\label{sec:org976e13e}
\subsection{Text code}
\label{sec:orgda837eb}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:org58f0bd5}
\subsection{Text}
\label{sec:org825c913}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:org1bd3e10}
...
\subsection{Diary}
\label{sec:orgcff73ef}
\subsubsection{Solving}
\label{sec:org6c4039a}
...
\label{sec:org25f1a9a}
\begin{enumerate}
\item Non-optimized
\label{sec:org53bfbd8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:org6186065}
\subsection{Question}
\label{sec:org6deb8d5}
...
\label{sec:org5b47d39}
\subsection{Question}
\label{sec:org18a9ca4}
...
\label{sec:orgde585b4}
\subsection{Question}
\label{sec:org7d916ba}
...
\subsection{Answer}
\label{sec:org4543737}
\subsubsection{\texttt{f}}
\label{sec:org8959732}
...
\label{sec:org451dd4a}
\subsection{Question}
\label{sec:org697dfbc}
...
\subsection{Answer}
\label{sec:org1b33e12}
\subsubsection{Recursive}
\label{sec:org39034a0}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org2ccc208}
\begin{enumerate}
\item Attempt 1
\label{sec:org53cc562}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgd019b44}
\subsection{Question}
\label{sec:org5befdb0}
...
\label{sec:orgbc184b5}
\subsection{Question}
\label{sec:org8422e9a}
...
\label{sec:orgca22948}
\subsection{Question 1}
\label{sec:orgbb1bf6d}
...
\label{sec:org1dd5ece}
\subsection{Text}
\label{sec:org6784083}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org36db847}
\subsection{Question}
\label{sec:org15b536c}
...
\label{sec:orgb2a2fcf}
\subsection{Question}
\label{sec:org9071679}
Using the results of \hyperref[sec:org1dd5ece]{Exercise 1.16} and \hyperref[sec:org36db847]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:org36e454e}
\subsubsection{Comparison benchmarks:}
\label{sec:orgf44862c}
...
\label{sec:orgfd51b9b}
\subsection{Question}
\label{sec:org2078710}
...
\label{sec:org8d2d107}
\subsection{Text}
\label{sec:org79556d1}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:orgd487c40}
\subsection{Text}
\label{sec:orga4aaf93}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgc70bcea}
\subsection{Question}
\label{sec:org4fc72fd}
...
\subsection{Answer}
\label{sec:orga98b853}
\subsubsection{Part 1}
\label{sec:org29f7b1f}
...
\label{sec:orgf02405f}
\subsection{Question}
\label{sec:orgc58169d}
...
\label{sec:org3993238}
\subsection{Text}
\label{sec:org94112e2}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org7c6bbe1}
\subsection{Question}
\label{sec:org6836556}
...
\label{sec:org527ceab}
\subsection{Question}
\label{sec:org773b627}
...
\label{sec:orga53c19b}
\subsection{Question}
\label{sec:org0c90a73}
...
\label{sec:org0149741}
\subsection{Question}
\label{sec:org8f12b24}
...
\label{sec:orgcf12570}
\subsection{Text}
\label{sec:org207c57c}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgedf3946}
\subsection{Question}
\label{sec:org40a3a16}
...
\label{sec:orgfad595a}
\subsection{Question 1.1}
\label{sec:orgc59ae25}
