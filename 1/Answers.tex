...
\label{sec:org92f6684}
\subsubsection{\texttt{try-these}}
\label{sec:org0246fd3}
...
\label{sec:orgb85b78e}
\subsection{Question}
\label{sec:orgf0cf240}
Below is a sequence of expressions. What is the result printed by the
interpreter in response to each expression? Assume that the sequence is to be
evaluated in the order in which it is presented.
\subsection{Answer}
\label{sec:orgc71a584}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
10 ;; 10
(+ 5 3 4) ;; 12
(- 9 1) ;; 8
...
\label{sec:orgef22eb6}
\subsection{Question}
\label{sec:org521fc17}
...
\label{sec:org00239f7}
\subsection{Text}
\label{sec:org14a6557}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (square x)
  (* x x))
\end{minted}
...
\label{sec:orgdcc1e3d}
\subsection{Question}
\label{sec:orgc87590f}
...
\label{sec:orgf801ea9}
\subsection{Question}
\label{sec:org6c42731}
...
\label{sec:org3f5f05d}
\subsection{Text code}
\label{sec:org2afc820}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
	  (- x)
...
\label{sec:org5efbcad}
\subsection{Text}
\label{sec:orgdcffddc}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsection{Question}
\label{sec:orge8d6929}
...
\subsection{Diary}
\label{sec:org15daa3b}
\subsubsection{Solving}
\label{sec:org8631456}
...
\label{sec:org96cd8cd}
\begin{enumerate}
\item Non-optimized
\label{sec:org24372dd}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(use-modules (ice-9 format))
(load "../mattbench.scm")
(define (average x y)
...
\label{sec:org102f365}
\subsection{Question}
\label{sec:org309390c}
...
\label{sec:orge6a141e}
\subsection{Question}
\label{sec:org0405d60}
...
\label{sec:orga4ddb17}
\subsection{Question}
\label{sec:org35fa959}
...
\subsection{Answer}
\label{sec:org93f1a1e}
\subsubsection{\texttt{f}}
\label{sec:orga48b0b6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<try-these>>
<<EX1-10-defs>>
...
\label{sec:org29c7c89}
\subsection{Question}
\label{sec:org5ae94c1}
...
\subsection{Answer}
\label{sec:org770282c}
\subsubsection{Recursive}
\label{sec:orgf3d051a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:org48faefd}
\begin{enumerate}
\item Attempt 1
\label{sec:org7224ab3}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org1f3e9e8}
\subsection{Question}
\label{sec:org9a0c7f5}
...
\label{sec:org753c2ec}
\subsection{Question}
\label{sec:org998480d}
...
\label{sec:org977345a}
\subsection{Question 1}
\label{sec:org43b4660}
...
\label{sec:org9c5f48b}
\subsection{Text}
\label{sec:org28371f1}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org3c3e4ca}
\subsection{Question}
\label{sec:orgea147c8}
...
\label{sec:org7cbc384}
\subsection{Question}
\label{sec:org11eb66e}
Using the results of \hyperref[sec:org9c5f48b]{Exercise 1.16} and \hyperref[sec:org3c3e4ca]{Exercise 1.17}, devise a procedure that
...
\subsection{Diary}
\label{sec:orgd74b8d8}
\subsubsection{Comparison benchmarks:}
\label{sec:org9fe4447}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(load "../mattbench.scm")
<<fast-mult-iter>>
<<fast-mult-rec>>
...
\label{sec:orgfa23f6a}
\subsection{Question}
\label{sec:orgd94552c}
...
\label{sec:orgaec0c40}
\subsection{Text}
\label{sec:org4873b71}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org4d4cf4c}
\subsection{Text}
\label{sec:org6516ccf}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orga0861c6}
\subsection{Question}
\label{sec:org01f486d}
...
\subsection{Answer}
\label{sec:org19d7047}
\subsubsection{Part 1}
\label{sec:org88be333}
