...
#+BEGIN_SRC scheme -n :eval no-export :tangle no :exports code :results value table
<<fast-expt-iter-fail1>>
<<try-these>>
(try-these (λ(x) (fast-expt-iter 2 x)) (cdr (iota 11)))
#+end_src

#+RESULTS[20c89dc11491fac4bf6312b450e149fa385fcd87]:
:results:
|  1 |   2 |
|  2 |   4 |
|  3 |   8 |
...
#+BEGIN_SRC scheme -n :eval no-export :tangle no :exports no :results output table :colnames yes
<<fast-expt-iter-fail1>>
<<try-these>>
(fast-expt-iter 2 6)
#+end_src

#+RESULTS[37635baa1b18ff8ce2d38ded346e3cccad079636]:
:results:
| base | power | variable |
|------+-------+----------|
|    2 |     6 |        1 |
