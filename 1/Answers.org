...
#+BEGIN_SRC scheme :eval no-export :results output :exports results
<<limited-fixed-point>>
<<average-varargs>>
;; Attempting to find sqrt of 4
(format #t "---Square Root---~%")
(format #t "Fixed point of y->x/y: ~a~%"
        (limited-fixed-point
         (λ(y) (/ 4 y))
         1.1))
(format #t "Fixed point of y->x/y(damped): ~a~%"
        (limited-fixed-point
         (λ(y) (average y (/ 4 y)))
         1.1))
(format #t "---Cube Root---~%")
(format #t "Fixed point of y->x/y^2(damped): ~a~%"
        (limited-fixed-point
         (λ(y) (average y (/ 4 (expt y 2))))
         1.1))
(format #t "---4th Root---~%")
(format #t "Fixed point of y->x/y^3(damped): ~a~%"
        (limited-fixed-point
         (λ(y) (average y (/ 4 (expt y 3))))
         1.1))
(format #t "Fixed point of y->x/y^3(damped 2x): ~a~%"
        (limited-fixed-point
         (λ(y) (average y y (/ 4 (expt y 3))))
         1.1))
(format #t "---5th Root---~%")
(format #t "Fixed point of y->x/y^4(damped 2x): ~a~%"
        (limited-fixed-point
         (λ(y) (average y y (/ 4 (expt y 4))))
         1.1))
(format #t "---6th Root---~%")
(format #t "Fixed point of y->x/y^5(damped 2x): ~a~%"
        (limited-fixed-point
         (λ(y) (average y y (/ 4 (expt y 5))))
         1.1))
(format #t "Fixed point of y->x/y^5(damped 3x): ~a~%"
        (limited-fixed-point
         (λ(y) (average y y y (/ 4 (expt y 5))))
         1.1))
(format #t "---7th Root---~%")
(format #t "Fixed point of y->x/y^6(damped 3x): ~a~%"
        (limited-fixed-point
         (λ(y) (average y y y (/ 4 (expt y 6))))
         1.1))
(format #t "---8th Root---~%")
(format #t "Fixed point of y->x/y^7(damped 3x): ~a~%"
        (limited-fixed-point
         (λ(y) (average y y y (/ 4 (expt y 7))))
         1.1))
(format #t "Fixed point of y->x/y^7(damped 4x): ~a~%"
        (limited-fixed-point
         (λ(y) (average y y y y (/ 4 (expt y 7))))
         1.1))
#+END_SRC

#+RESULTS[008ac3fac76f83e1c453c168cec527c116cb630a]: nth-damp-experiments
:results:
---Square Root---
Fixed point of y->x/y: LIMIT REACHED
Fixed point of y->x/y(damped): 2.0
---Cube Root---
Fixed point of y->x/y^2(damped): 1.5874034972129285
---4th Root---
Fixed point of y->x/y^3(damped): LIMIT REACHED
Fixed point of y->x/y^3(damped 2x): 1.414214590925529
---5th Root---
Fixed point of y->x/y^4(damped 2x): 1.3195118218452988
---6th Root---
Fixed point of y->x/y^5(damped 2x): LIMIT REACHED
Fixed point of y->x/y^5(damped 3x): 1.2599232881307922
---7th Root---
Fixed point of y->x/y^6(damped 3x): 1.219009628306786
---8th Root---
Fixed point of y->x/y^7(damped 3x): LIMIT REACHED
Fixed point of y->x/y^7(damped 4x): 1.1892046281030577
:end:
