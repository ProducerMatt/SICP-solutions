...
#+BEGIN_SRC scheme -n :eval no-export :tangle Ex1-18bench.scheme :exports both :results silent
(load "../mattbench.scm")
<<fast-mult-iter>>
<<fast-mult-rec>>

(list (list "fast-mult-rec" "fast-mult-iter")
      (list (mattbench (λ() (fast-mult-rec 32 32)) 1000)
            (mattbench (λ() (fast-mult 32 32)) 1000)))
#+END_SRC
*** Hall of shame
