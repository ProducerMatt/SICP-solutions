...
:MODIFIED: 2022-08-25 21:28
:END:
** Question
:PROPERTIES:
:HASH:     -277441515348154865
:MODIFIED: 2022-08-26 17:24
:END:
...
#+NAME: fib-iter-test
#+BEGIN_SRC scheme -n :eval no-export :tangle no :exports results :results value table :colnames yes
(use-srfis '(1))
<<fib-iter-T>>
(let* ((l (cdr (iota 10)))
       (fr (map fib-rec l))
       (fi (map fib l)))
  (cons (list "n" "fib-rec" "fib-iter")
        (zip l fr fi)))
#+END_SRC

#+RESULTS[cb0486d64121e11bc67b9d79dc8831099f46c360]: fib-iter-test
:results:
| n | fib-rec | fib-iter |
| 1 |       1 |        1 |
| 2 |       1 |        1 |
