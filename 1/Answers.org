...
** Answer
#+NAME: car-test
#+begin_src scheme -n :tangle yes :results silent :exports code :eval no-export
<<expmod>>
(define (car-test n)
  (define (check a)
...
#+NAME: car-test
#+BEGIN_SRC scheme -n :results value code :exports both :eval no-export
<<car-test>>
...
#+RESULTS[942adcfd272a3e4ea79bf62bd22e523a1599e8b0]: car-test
#+begin_src scheme
(#f #t #t)
#+end_src
