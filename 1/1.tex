...
the steady divergence from the correct answers here:
...
\begin{Highlighting}[]
\NormalTok{\textless{}\textless{}inferior{-}good{-}enough\textgreater{}\textgreater{}}
\NormalTok{(map (}\KeywordTok{lambda}\NormalTok{ (x) (}\KeywordTok{display}\NormalTok{ x) (}\KeywordTok{display} \StringTok{" "}\NormalTok{))}
\NormalTok{     (map new{-}sqrt \textquotesingle{}(}\FloatTok{0.1} \FloatTok{0.01} \FloatTok{0.001} \FloatTok{0.0001} \FloatTok{0.00001}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\toprule
\endhead
0.31622776601683794 & 0.1 & 0.03162277660168379 & 0.01 &
