...
\NormalTok{(transpose{-}list (map }\KeywordTok{sqrt}\NormalTok{ \textquotesingle{}(}\FloatTok{0.1} \FloatTok{0.01} \FloatTok{0.001} \FloatTok{0.0001} \FloatTok{0.00001}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{\textless{}\textless{}transpose{-}list\textgreater{}\textgreater{}}
\NormalTok{\textless{}\textless{}inferior{-}good{-}enough\textgreater{}\textgreater{}}
\NormalTok{(transpose{-}list (map new{-}sqrt \textquotesingle{}(}\FloatTok{0.1} \FloatTok{0.01} \FloatTok{0.001} \FloatTok{0.0001} \FloatTok{0.00001}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
