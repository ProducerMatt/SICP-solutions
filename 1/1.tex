...
the steady divergence from correct answers here (should alternate
between values starting with "316" and "100"):

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textless{}\textless{}txt{-}sqrt\textgreater{}\textgreater{}}
\NormalTok{(}\KeywordTok{display}\NormalTok{ (map }\KeywordTok{sqrt}\NormalTok{ \textquotesingle{}(}\FloatTok{0.1} \FloatTok{0.01} \FloatTok{0.001} \FloatTok{0.0001} \FloatTok{0.00001}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}
...
\toprule
\endhead
0.316245562280389 & 0.10032578510960605 & 0.04124542607499115 &
0.03230844833048122 & 0.03135649010771716 \\
\bottomrule
\end{longtable}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textless{}\textless{}print{-}as{-}rows\textgreater{}\textgreater{}}
\NormalTok{\textless{}\textless{}inferior{-}good{-}enough\textgreater{}\textgreater{}}
\NormalTok{(print{-}as{-}rows (map new{-}sqrt \textquotesingle{}(}\FloatTok{0.1} \FloatTok{0.01} \FloatTok{0.001} \FloatTok{0.0001} \FloatTok{0.00001}\NormalTok{)))}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{0.31622776601683794}
\NormalTok{0.1}
\NormalTok{0.03162277660168379}
\NormalTok{0.01}
\NormalTok{0.0031622776601683794}
\end{Highlighting}
\end{Shaded}
