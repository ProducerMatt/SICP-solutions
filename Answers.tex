...
\label{sec:org64e3c26}
\subsection{Text Foreword}
\label{sec:org941710c}
...
\label{sec:orgd17dafa}
\subsubsection{Question}
\label{sec:org7d062ba}
\begin{quote}
...
\label{sec:org0ece7e0}
\subsubsection{Question}
\label{sec:org7afaafa}
\begin{quote}
...
\label{sec:orgf95b0d2}
\subsubsection{Question}
\label{sec:orgb7e29e2}
\begin{quote}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\end{quote}
\subsubsection{Answer}
\label{sec:org291d519}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org91cbb57}
\subsubsection{Question}
\label{sec:orgd18b2ad}
\begin{quote}
...
\label{sec:org278035d}
\subsubsection{Question}
\label{sec:org01f4928}
\begin{quote}
...
\label{sec:org5482ec4}
\subsubsection{Text code}
\label{sec:org39c047a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
      (- x)
...
\label{sec:orgb844589}
\subsubsection{Text}
\label{sec:org7674a0d}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsubsection{Question}
\label{sec:org129b30d}
\begin{quote}
...
\end{quote}
\subsubsection{Diary}
\label{sec:orgb466296}
\begin{enumerate}
\item Solving
\label{sec:org91d666b}
...
\label{sec:org81289f0}
\begin{enumerate}
\item Non-optimized
\label{sec:org1276b6a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org9243e25}
\subsubsection{Question}
\label{sec:orgad21929}
\begin{quote}
...
\label{sec:org43a5247}
\subsubsection{Question}
\label{sec:orgd0ce3c6}
\begin{quote}
...
\label{sec:orgce8d9c5}
\subsubsection{Question}
\label{sec:org8c7a3a0}
\begin{quote}
...
\subsubsection{Answer}
\label{sec:orgd88fb77}
\begin{enumerate}
\item \texttt{f}
\label{sec:org81b8977}
...
\end{quote}
\subsubsection{Answer}
\label{sec:orgfeb1e16}
\begin{enumerate}
\item Recursive
\label{sec:orgdc1d952}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\item Iterative
\label{sec:org777138a}
\begin{enumerate}
\item Attempt 1
\label{sec:orgc0d2e43}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgc35f9a0}
\subsubsection{Question}
\label{sec:orga502ddb}
\begin{quote}
...
\label{sec:orga79c90c}
\subsubsection{Question}
\label{sec:orge3d555c}
\begin{quote}
...
\label{sec:orgaef0f7d}
\subsubsection{Question A}
\label{sec:org1495fc7}
\begin{quote}
...
\label{sec:org4f07690}
\subsubsection{Text}
\label{sec:orgd11615a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org29eb7ce}
\subsubsection{Question}
\label{sec:orgf250fca}
\begin{quote}
...
\label{sec:org13903a3}
\subsubsection{Question}
\label{sec:org43b5091}
\begin{quote}
Using the results of \hyperref[sec:org4f07690]{Exercise 1.16} and \hyperref[sec:org29eb7ce]{Exercise 1.17}, devise a procedure that
...
\end{quote}
\subsubsection{Diary}
\label{sec:org87d1630}
\begin{enumerate}
\item Comparison benchmarks:
\label{sec:orgc9e6cd6}
...
\label{sec:org9927d46}
\subsubsection{Question}
\label{sec:org891127d}
\begin{quote}
...
\label{sec:org6f2b798}
\subsubsection{Text}
\label{sec:org20ca6b6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:orgf6d32a2}
\subsubsection{Text}
\label{sec:orgc962437}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgc279cdf}
\subsubsection{Question}
\label{sec:org6bfd181}
\begin{quote}
...
\subsubsection{Answer}
\label{sec:org119cc57}
\begin{enumerate}
\item Part 1
\label{sec:org11a45ff}
...
\label{sec:orgc6971dc}
\subsubsection{Question}
\label{sec:org7355992}
\begin{quote}
...
\label{sec:org052e30a}
\subsubsection{Text}
\label{sec:org5feacb3}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org9a8c045}
\subsubsection{Question}
\label{sec:org1cead96}
\begin{quote}
...
\label{sec:org1651c50}
\subsubsection{Question}
\label{sec:orgb915a8f}
\begin{quote}
...
\label{sec:org29ddc5b}
\subsubsection{Question}
\label{sec:org56db0db}
\begin{quote}
...
\label{sec:org05a2131}
\subsubsection{Question}
\label{sec:orgc394784}
\begin{quote}
...
\label{sec:org9196cd2}
\subsubsection{Text}
\label{sec:orgdab6fff}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (sum term a next b)
  (if (> a b)
      0
...
\label{sec:org7d00a4b}
\subsubsection{Question}
\label{sec:org029f229}
\begin{quote}
...
\label{sec:org1df7aa1}
\subsubsection{Question A.1}
\label{sec:orgfde5c37}
\begin{quote}
...
\label{sec:orgb61dca0}
\subsubsection{Question A}
\label{sec:orga958c97}
\begin{quote}
...
\label{sec:orge853409}
\subsubsection{Question A}
\label{sec:orgf4a56c5}
\index{filter}
\begin{quote}
...
\label{sec:org6853978}
\subsubsection{Question}
\label{sec:org4bf682a}
\begin{quote}
...
\label{sec:orga5b737d}
\subsubsection{Text}
\label{sec:orgefbcdcc}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org9111dd8}
\subsubsection{Question}
\label{sec:org96bdf59}
\begin{quote}
...
\label{sec:org82b84e2}
\subsubsection{Question A}
\label{sec:orgf1ec369}
\begin{quote}
...
\label{sec:orge00ee6f}
\subsubsection{Question}
\label{sec:org793c289}
\begin{quote}
...
\label{sec:orga8b5239}
\subsubsection{Question}
\label{sec:orgbf70f7d}
\begin{quote}
...
\label{sec:org2e1ceb1}
\subsubsection{Text}
\label{sec:org6bd312f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orge008b35}
\subsubsection{Question}
\label{sec:org9b693d6}
\begin{quote}
...
\label{sec:org81f9e57}
\subsubsection{Question}
\label{sec:org5c11caf}
\begin{quote}
...
\label{sec:orgd654f60}
\subsubsection{Question}
\label{sec:org6f52a67}
\begin{quote}
...
\label{sec:orgd4396ff}
\subsubsection{Question}
\label{sec:org0ec2fe6}
\index{smoothing}
\begin{quote}
...
\label{sec:org077b8db}
\subsubsection{Question}
\label{sec:org2f244e5}
\begin{quote}
...
\label{sec:org0682dae}
\subsubsection{Question}
\label{sec:org1094202}
\begin{quote}
...
\label{sec:org02a4e57}
\subsubsection{Question}
\label{sec:org7efc98a}
\begin{quote}
...
\subsubsection{Answer}
\label{sec:org0b2de8a}

\subsection{Exercise 2.2}
\label{sec:org05eb04f}
\subsubsection{Question}
\label{sec:orgba58657}
...
\end{minted}
\subsubsection{Answer}
\label{sec:org9ab2d7b}
\subsection{2.1.3: What Is Meant by Data?}
\label{sec:org7e2d370}
