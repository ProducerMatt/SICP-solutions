...
\label{sec:orgcc4f618}
\subsection{Text Foreword}
\label{sec:org5b2e090}
...
\label{sec:orgfbe5239}
\subsubsection{Question}
\label{sec:org0689f7e}
\begin{quote}
...
\label{sec:org17260e3}
\subsubsection{Question}
\label{sec:org3f67729}
\begin{quote}
...
\label{sec:orgca7cbba}
\subsubsection{Question}
\label{sec:org8017473}
\begin{quote}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\end{quote}
\subsubsection{Answer}
\label{sec:org89104ea}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgf0dedba}
\subsubsection{Question}
\label{sec:org01788c4}
\begin{quote}
...
\label{sec:org0557a7c}
\subsubsection{Question}
\label{sec:org401b7be}
\begin{quote}
...
\label{sec:org2e40138}
\subsubsection{Text code}
\label{sec:org38d567e}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
      (- x)
...
\label{sec:org4b3e3f0}
\subsubsection{Text}
\label{sec:orgf1c5b14}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsubsection{Question}
\label{sec:orgdf28d43}
\begin{quote}
...
\end{quote}
\subsubsection{Diary}
\label{sec:orgc090578}
\begin{enumerate}
\item Solving
\label{sec:org68bd5dd}
...
\label{sec:orgbd3ccd1}
\begin{enumerate}
\item Non-optimized
\label{sec:org56581d0}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org2c19fce}
\subsubsection{Question}
\label{sec:org0112a0f}
\begin{quote}
...
\label{sec:org85a25f2}
\subsubsection{Question}
\label{sec:orgb56a48a}
\begin{quote}
...
\label{sec:org96553e6}
\subsubsection{Question}
\label{sec:orga14d08b}
\begin{quote}
...
\subsubsection{Answer}
\label{sec:orgf7909d9}
\begin{enumerate}
\item \texttt{f}
\label{sec:orgcfb8698}
...
\end{quote}
\subsubsection{Answer}
\label{sec:org2e53537}
\begin{enumerate}
\item Recursive
\label{sec:org443a6c6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\item Iterative
\label{sec:orgbc1f88f}
\begin{enumerate}
\item Attempt 1
\label{sec:orgd7f1331}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orga688ca9}
\subsubsection{Question}
\label{sec:orge905869}
\begin{quote}
...
\label{sec:orgd5a02fe}
\subsubsection{Question}
\label{sec:orgb9878c2}
\begin{quote}
...
\label{sec:orgd6611ee}
\subsubsection{Question A}
\label{sec:org3d03625}
\begin{quote}
...
\label{sec:org1f85c2a}
\subsubsection{Text}
\label{sec:org6de3c09}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org3b3fd9f}
\subsubsection{Question}
\label{sec:orga0b76f7}
\begin{quote}
...
\label{sec:org4de1583}
\subsubsection{Question}
\label{sec:org272f767}
\begin{quote}
Using the results of \hyperref[sec:org1f85c2a]{Exercise 1.16} and \hyperref[sec:org3b3fd9f]{Exercise 1.17}, devise a procedure that
...
\end{quote}
\subsubsection{Diary}
\label{sec:org8e448b0}
\begin{enumerate}
\item Comparison benchmarks:
\label{sec:org85fa75c}
...
\label{sec:org535bef1}
\subsubsection{Question}
\label{sec:org26f7e2a}
\begin{quote}
...
\label{sec:orgc3f0198}
\subsubsection{Text}
\label{sec:orgaef5719}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org7a7156c}
\subsubsection{Text}
\label{sec:org6bd7612}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org9c7c51e}
\subsubsection{Question}
\label{sec:orga19d2f3}
\begin{quote}
...
\subsubsection{Answer}
\label{sec:orgc5ea72f}
\begin{enumerate}
\item Part 1
\label{sec:org4d7fccc}
...
\label{sec:orgfefbab0}
\subsubsection{Question}
\label{sec:org02ad816}
\begin{quote}
...
\label{sec:orge9b68a6}
\subsubsection{Text}
\label{sec:org7b82d4f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org67da507}
\subsubsection{Question}
\label{sec:orgbe7af18}
\begin{quote}
...
\label{sec:org13af2c0}
\subsubsection{Question}
\label{sec:orgf44b1d2}
\begin{quote}
...
\label{sec:org201727d}
\subsubsection{Question}
\label{sec:org8f811d1}
\begin{quote}
...
\label{sec:orge978632}
\subsubsection{Question}
\label{sec:org159b211}
\begin{quote}
...
\label{sec:org4469c17}
\subsubsection{Text}
\label{sec:org8da6e55}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (sum term a next b)
  (if (> a b)
      0
...
\label{sec:orgfe0fd21}
\subsubsection{Question}
\label{sec:orge26e8ca}
\begin{quote}
...
\label{sec:orgae204cc}
\subsubsection{Question A.1}
\label{sec:org48bbccd}
\begin{quote}
...
\label{sec:org6d431a7}
\subsubsection{Question A}
\label{sec:orga3b5a15}
\begin{quote}
...
\label{sec:orgd65e626}
\subsubsection{Question A}
\label{sec:org61b4947}
\index{filter}
\begin{quote}
...
\label{sec:org774763e}
\subsubsection{Question}
\label{sec:orge2719a0}
\begin{quote}
...
\label{sec:org1cd8e1e}
\subsubsection{Text}
\label{sec:org9f896ef}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgb2e038d}
\subsubsection{Question}
\label{sec:org6dd5f68}
\begin{quote}
...
\label{sec:org829ed07}
\subsubsection{Question A}
\label{sec:orgca2af57}
\begin{quote}
...
\label{sec:org9a5bd5c}
\subsubsection{Question}
\label{sec:orgaa5d373}
\begin{quote}
...
\label{sec:orgd76115c}
\subsubsection{Question}
\label{sec:org2179555}
\begin{quote}
...
\label{sec:org73cab03}
\subsubsection{Text}
\label{sec:org625bba2}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgf9d8315}
\subsubsection{Question}
\label{sec:orgd30741d}
\begin{quote}
...
\label{sec:org223694e}
\subsubsection{Question}
\label{sec:org9e29ec2}
\begin{quote}
...
\label{sec:org05a613c}
\subsubsection{Question}
\label{sec:orgba219c8}
\begin{quote}
...
\label{sec:org99c4de5}
\subsubsection{Question}
\label{sec:orgf810f25}
\index{smoothing}
\begin{quote}
...
\label{sec:orgcd37f44}
\subsubsection{Question}
\label{sec:org88db859}
\begin{quote}
...
\label{sec:org5e898b4}
\subsubsection{Question}
\label{sec:orge336354}
\begin{quote}
...
\label{sec:orgb53fbbe}
\subsubsection{Text}
\label{sec:orge5df2c8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (add-rat x y)
...
\label{sec:org37d4e5f}
\subsubsection{Question}
\label{sec:orgf86d42d}
...
\label{sec:org61e317f}
\subsubsection{Question}
\label{sec:org9506d8c}
...
(define (length-segment seg)
  (length-points (start-segment seg)
                 (end-segment seg)))
\end{minted}
...
(define (rect-c R)
  (add-points
   (rect-origin R)
   (make-point (* (cos (radian (rect-angle R)))
                  (rect-width R))
               (* (sin (radian (rect-angle R)))
                  (rect-width R)))))
;; rect-a can be rotated by 90 degrees just by using
;;   (-sin(Theta),cos(Theta)) * height
(define (rect-a R)
  (add-points
   (rect-origin R)
   (make-point (* (- (sin (radian (rect-angle R))))
                  (rect-height R))
               (* (cos (radian (rect-angle R)))
                  (rect-height R)))))
\end{minted}
\subsection{2.1.3: What Is Meant by Data?}
\label{sec:orgda6622e}
