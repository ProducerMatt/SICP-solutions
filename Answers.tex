...
\label{sec:orgbc3c8dc}
\subsection{Text Foreword}
\label{sec:org621d43e}
...
\label{sec:org1951a61}
\subsubsection{Question}
\label{sec:org7a4af89}
\begin{quote}
...
\label{sec:org598d3a6}
\subsubsection{Question}
\label{sec:org04c1e7c}
\begin{quote}
...
\label{sec:org2e77e03}
\subsubsection{Question}
\label{sec:org15a47fe}
\begin{quote}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\end{quote}
\subsubsection{Answer}
\label{sec:orgb881634}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orge442ae9}
\subsubsection{Question}
\label{sec:org041acde}
\begin{quote}
...
\label{sec:orgcfb9310}
\subsubsection{Question}
\label{sec:org5fe4b9b}
\begin{quote}
...
\label{sec:orga2cdef0}
\subsubsection{Text code}
\label{sec:org1a9148a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
      (- x)
...
\label{sec:org7d8d05d}
\subsubsection{Text}
\label{sec:orgc2cd8cd}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsubsection{Question}
\label{sec:orgf144bf5}
\begin{quote}
...
\end{quote}
\subsubsection{Diary}
\label{sec:org0666a91}
\begin{enumerate}
\item Solving
\label{sec:orgf6ef1d6}
...
\label{sec:org2ebfed1}
\begin{enumerate}
\item Non-optimized
\label{sec:orgdbd8616}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org17fe07c}
\subsubsection{Question}
\label{sec:org7d4a8b8}
\begin{quote}
...
\label{sec:org06d55e5}
\subsubsection{Question}
\label{sec:org494bc22}
\begin{quote}
...
\label{sec:org4de4d7d}
\subsubsection{Question}
\label{sec:org7f53629}
\begin{quote}
...
\subsubsection{Answer}
\label{sec:org1d7ba61}
\begin{enumerate}
\item \texttt{f}
\label{sec:orgbd96e7f}
...
\end{quote}
\subsubsection{Answer}
\label{sec:org8cb58a2}
\begin{enumerate}
\item Recursive
\label{sec:orgcd358f1}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\item Iterative
\label{sec:org1a5a0de}
\begin{enumerate}
\item Attempt 1
\label{sec:org2158375}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org4c09285}
\subsubsection{Question}
\label{sec:org426d555}
\begin{quote}
...
\label{sec:orgdcdac8a}
\subsubsection{Question}
\label{sec:org82e27bb}
\begin{quote}
...
\begin{center}
\includegraphics[width=.9\linewidth]{1/fig/cc-test.png}
\end{center}
...
\label{sec:org673c1eb}
\subsubsection{Question A}
\label{sec:org0bf8c8c}
\begin{quote}
...
\label{sec:org9b5c20f}
\subsubsection{Text}
\label{sec:org7d08174}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org3d1e594}
\subsubsection{Question}
\label{sec:org0008cc7}
\begin{quote}
...
\label{sec:org75bec58}
\subsubsection{Question}
\label{sec:orgf2c31bc}
\begin{quote}
Using the results of \hyperref[sec:org9b5c20f]{Exercise 1.16} and \hyperref[sec:org3d1e594]{Exercise 1.17}, devise a procedure that
...
\end{quote}
\subsubsection{Diary}
\label{sec:orgb77012d}
\begin{enumerate}
\item Comparison benchmarks:
\label{sec:orgb6b5f1c}
...
\label{sec:org959e656}
\subsubsection{Question}
\label{sec:org2a251f3}
\begin{quote}
...
\label{sec:org9714c3f}
\subsubsection{Text}
\label{sec:orgaa5fb79}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org344779a}
\subsubsection{Text}
\label{sec:org330ba6e}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org2a22e8c}
\subsubsection{Question}
\label{sec:orga055221}
\begin{quote}
...
\subsubsection{Answer}
\label{sec:orgd269eb3}
\begin{enumerate}
\item Part 1
\label{sec:org8fede4b}
...
\label{sec:orge048cd6}
\subsubsection{Question}
\label{sec:org4d014a2}
\begin{quote}
...
\label{sec:orgb0381fc}
\subsubsection{Text}
\label{sec:org36072dd}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org03daebf}
\subsubsection{Question}
\label{sec:org6be47ea}
\begin{quote}
...
\label{sec:orgb918ff5}
\subsubsection{Question}
\label{sec:org6fe55d9}
\begin{quote}
...
\label{sec:orgbdca731}
\subsubsection{Question}
\label{sec:org9e92af4}
\begin{quote}
...
\label{sec:org785edff}
\subsubsection{Question}
\label{sec:orga6a0fed}
\begin{quote}
...
\label{sec:org42cd88a}
\subsubsection{Text}
\label{sec:orga26d221}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (sum term a next b)
  (if (> a b)
      0
...
\label{sec:orge6a71be}
\subsubsection{Question}
\label{sec:org7c6c6c9}
\begin{quote}
...
\label{sec:orgf0d081c}
\subsubsection{Question A.1}
\label{sec:orgdb80523}
\begin{quote}
...
\label{sec:org385aec1}
\subsubsection{Question A}
\label{sec:orgdc960b8}
\begin{quote}
...
\label{sec:org79fb4f2}
\subsubsection{Question A}
\label{sec:orgd0ab9fb}
\index{filter}
\begin{quote}
...
\label{sec:org8d10526}
\subsubsection{Question}
\label{sec:org64e8b40}
\begin{quote}
...
\label{sec:orgf3b3eba}
\subsubsection{Text}
\label{sec:orgcedbc07}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgf58ca91}
\subsubsection{Question}
\label{sec:org7353858}
\begin{quote}
...
\label{sec:org72ccd3d}
\subsubsection{Question A}
\label{sec:org5918a90}
\begin{quote}
...
\label{sec:orgf907f55}
\subsubsection{Question}
\label{sec:org6cbd374}
\begin{quote}
...
\label{sec:orgde3b4cb}
\subsubsection{Question}
\label{sec:org26eb514}
\begin{quote}
...
\label{sec:org7bb28d7}
\subsubsection{Text}
\label{sec:org7be527b}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgf504f70}
\subsubsection{Question}
\label{sec:org0e17bc1}
\begin{quote}
...
\label{sec:orge24fd66}
\subsubsection{Question}
\label{sec:org9d19852}
\begin{quote}
...
\label{sec:org2900ba8}
\subsubsection{Question}
\label{sec:orgf5f321c}
\begin{quote}
...
\label{sec:org8febddd}
\subsubsection{Question}
\label{sec:orge0cb1dd}
\index{smoothing}
\begin{quote}
...
\label{sec:orgcc4fb01}
\subsubsection{Question}
\label{sec:org3f0e3be}
\begin{quote}
...
\label{sec:orge3270b4}
\subsubsection{Question}
\label{sec:org92548b9}
\begin{quote}
