...
\label{sec:org7a00b0d}
\subsection{Text Foreword}
\label{sec:orgf1ef7d7}
...
\label{sec:org16142e4}
\subsubsection{Question}
\label{sec:orgf27c645}
\begin{quote}
...
\label{sec:org67771cd}
\subsubsection{Question}
\label{sec:org012898b}
\begin{quote}
...
\label{sec:org9b7070a}
\subsubsection{Question}
\label{sec:org1aac6db}
\begin{quote}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\end{quote}
\subsubsection{Answer}
\label{sec:org4a0fc36}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org0881670}
\subsubsection{Question}
\label{sec:orgb63bdce}
\begin{quote}
...
\label{sec:org962f114}
\subsubsection{Question}
\label{sec:org2fb6924}
\begin{quote}
...
\label{sec:org1c24d6d}
\subsubsection{Text code}
\label{sec:org8021d39}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
      (- x)
...
\label{sec:orgb74c283}
\subsubsection{Text}
\label{sec:org7713556}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsubsection{Question}
\label{sec:org5d66ae4}
\begin{quote}
...
\end{quote}
\subsubsection{Diary}
\label{sec:orga5dfa34}
\begin{enumerate}
\item Solving
\label{sec:orgbffa708}
...
\label{sec:orgb119c0f}
\begin{enumerate}
\item Non-optimized
\label{sec:org99dc4d8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org86e7f6b}
\subsubsection{Question}
\label{sec:org94619fd}
\begin{quote}
...
\label{sec:orgeabb833}
\subsubsection{Question}
\label{sec:orga8faaa2}
\begin{quote}
...
\label{sec:org3aca0a8}
\subsubsection{Question}
\label{sec:org4b1042b}
\begin{quote}
...
\subsubsection{Answer}
\label{sec:org6054183}
\begin{enumerate}
\item \texttt{f}
\label{sec:org7265273}
...
\end{quote}
\subsubsection{Answer}
\label{sec:orgeb84a35}
\begin{enumerate}
\item Recursive
\label{sec:org7e2b900}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\item Iterative
\label{sec:orgb6925bc}
\begin{enumerate}
\item Attempt 1
\label{sec:org7060198}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org6aadb17}
\subsubsection{Question}
\label{sec:org9eba883}
\begin{quote}
...
\label{sec:org22f45d7}
\subsubsection{Question}
\label{sec:org6db7bc7}
\begin{quote}
...
\label{sec:org6b2c610}
\subsubsection{Question A}
\label{sec:orgf3ff8c4}
\begin{quote}
...
\label{sec:org5e90366}
\subsubsection{Text}
\label{sec:orgc039f65}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org71d9925}
\subsubsection{Question}
\label{sec:org4ffbffa}
\begin{quote}
...
\label{sec:org7b994ac}
\subsubsection{Question}
\label{sec:org5b66fd8}
\begin{quote}
Using the results of \hyperref[sec:org5e90366]{Exercise 1.16} and \hyperref[sec:org71d9925]{Exercise 1.17}, devise a procedure that
...
\end{quote}
\subsubsection{Diary}
\label{sec:org7f5dd7e}
\begin{enumerate}
\item Comparison benchmarks:
\label{sec:org90bc179}
...
\label{sec:orgf8bdcbd}
\subsubsection{Text}
\label{sec:orgc15897a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org04e1b8e}
\subsubsection{Text}
\label{sec:org710cc7a}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org3349a65}
\subsubsection{Question}
\label{sec:orgb341e34}
\begin{quote}
...
\subsubsection{Answer}
\label{sec:orgf1a10c3}
\begin{enumerate}
\item Part 1
\label{sec:org0bc1635}
...
\label{sec:orge0e7233}
\subsubsection{Question}
\label{sec:org747385e}
\begin{quote}
...
\label{sec:org1a0c164}
\subsubsection{Text}
\label{sec:org50f7aa6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgde4d24e}
\subsubsection{Question}
\label{sec:org678d129}
\begin{quote}
...
\label{sec:org01245a9}
\subsubsection{Question}
\label{sec:orgd87436a}
\begin{quote}
...
\label{sec:org4a56044}
\subsubsection{Question}
\label{sec:org2b14f9a}
\begin{quote}
...
\label{sec:org4a6aed3}
\subsubsection{Question}
\label{sec:orgf09fad1}
\begin{quote}
...
\label{sec:org6db795f}
\subsubsection{Text}
\label{sec:orgd513313}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (sum term a next b)
  (if (> a b)
      0
...
\label{sec:org3c9815f}
\subsubsection{Question}
\label{sec:orgc244075}
\begin{quote}
...
\label{sec:orga71f30d}
\subsubsection{Question A.1}
\label{sec:org5354143}
\begin{quote}
...
\label{sec:org015cd17}
\subsubsection{Question A}
\label{sec:org74ba58d}
\begin{quote}
...
\label{sec:org534a9fb}
\subsubsection{Question A}
\label{sec:org24378bc}
\index{filter}
\begin{quote}
...
\label{sec:orgeaa62f9}
\subsubsection{Question}
\label{sec:orgbcfaa36}
\begin{quote}
...
\label{sec:org3e22908}
\subsubsection{Text}
\label{sec:orgc0e1a27}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgfd6b6a2}
\subsubsection{Question}
\label{sec:org220f176}
\begin{quote}
...
\label{sec:org07c478f}
\subsubsection{Question A}
\label{sec:org8360fe3}
\begin{quote}
...
\label{sec:orgfdcb2d6}
\subsubsection{Question}
\label{sec:org7ca8e94}
\begin{quote}
...
\label{sec:orgecbdbb4}
\subsubsection{Question}
\label{sec:org36519ca}
\begin{quote}
...
\label{sec:org4129453}
\subsubsection{Text}
\label{sec:orge35b5ef}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgf103658}
\subsubsection{Question}
\label{sec:org5875ff5}
\begin{quote}
...
\label{sec:orgc5fa2ad}
\subsubsection{Question}
\label{sec:org0b01ba0}
\begin{quote}
...
\label{sec:org5077504}
\subsubsection{Question}
\label{sec:org3572573}
\begin{quote}
...
\label{sec:orgf7304e5}
\subsubsection{Question}
\label{sec:org382e588}
\index{smoothing}
\begin{quote}
...
\label{sec:orgd76550f}
\subsubsection{Question}
\label{sec:orgcec40dd}
\begin{quote}
...
\label{sec:orgaea93e0}
\subsubsection{Question}
\label{sec:org4331d1c}
\begin{quote}
...
\label{sec:org118b067}
\subsubsection{Text}
\label{sec:org043dad2}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (add-rat x y)
...
\label{sec:org393b217}
\subsubsection{Question}
\label{sec:orgcb6a1e8}
...
\label{sec:org8461fbd}
\subsubsection{Question}
\label{sec:orge699a04}
...
FAIL at rect-b (WXYZ)
expected: (-0.5 . -0.5)
returned: (-2.292893218813452 . 2.5355339059327378)
SUCCEED at rect-height
SUCCEED at rect-width
SUCCEED at rect-area ABCD
SUCCEED at rect-area WXYZ
