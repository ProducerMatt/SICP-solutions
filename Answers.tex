...
\label{sec:orgbc52962}
\subsection{Text Foreword}
\label{sec:org12c6198}
...
\label{sec:org43efdf2}
\subsubsection{Question}
\label{sec:org262f071}
\begin{quote}
...
\label{sec:orgb39fcb1}
\subsubsection{Question}
\label{sec:org6e2ef0c}
\begin{quote}
...
\label{sec:orga4c0ff9}
\subsubsection{Question}
\label{sec:org3e9653d}
\begin{quote}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\end{quote}
\subsubsection{Answer}
\label{sec:org605bbe2}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org377fc67}
\subsubsection{Question}
\label{sec:org517575b}
\begin{quote}
...
\label{sec:orgbd32a87}
\subsubsection{Question}
\label{sec:org2448492}
\begin{quote}
...
\label{sec:org29336d1}
\subsubsection{Text code}
\label{sec:org79e5ee6}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
      (- x)
...
\label{sec:org3f6cab6}
\subsubsection{Text}
\label{sec:org240dfc5}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsubsection{Question}
\label{sec:org105f935}
\begin{quote}
...
\end{quote}
\subsubsection{Diary}
\label{sec:org262bbbd}
\begin{enumerate}
\item Solving
\label{sec:org2b9a6d8}
...
\label{sec:org2247e03}
\begin{enumerate}
\item Non-optimized
\label{sec:org96861c9}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org740b278}
\subsubsection{Question}
\label{sec:orgcfc0724}
\begin{quote}
...
\label{sec:org1d1eca1}
\subsubsection{Question}
\label{sec:org328006d}
\begin{quote}
...
\label{sec:org5b4a680}
\subsubsection{Question}
\label{sec:org74fad09}
\begin{quote}
...
\subsubsection{Answer}
\label{sec:org9ff1f2b}
\begin{enumerate}
\item \texttt{f}
\label{sec:orgaa903e1}
...
\end{quote}
\subsubsection{Answer}
\label{sec:orgb50f008}
\begin{enumerate}
\item Recursive
\label{sec:org8737204}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\item Iterative
\label{sec:orgf417633}
\begin{enumerate}
\item Attempt 1
\label{sec:org508aeed}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org7057d4a}
\subsubsection{Question}
\label{sec:org3713aa8}
\begin{quote}
...
\label{sec:org40518fd}
\subsubsection{Question}
\label{sec:org72ab464}
\begin{quote}
...
\label{sec:org86b3f7f}
\subsubsection{Question A}
\label{sec:orge4014c8}
\begin{quote}
...
\label{sec:orgc81cef9}
\subsubsection{Text}
\label{sec:org8750d24}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:orgdd78f66}
\subsubsection{Question}
\label{sec:org97ae1db}
\begin{quote}
...
\label{sec:org7568b85}
\subsubsection{Question}
\label{sec:org24a3191}
\begin{quote}
Using the results of \hyperref[sec:orgc81cef9]{Exercise 1.16} and \hyperref[sec:orgdd78f66]{Exercise 1.17}, devise a procedure that
...
\end{quote}
\subsubsection{Diary}
\label{sec:org53a2069}
\begin{enumerate}
\item Comparison benchmarks:
\label{sec:org88242d3}
...
\label{sec:orgc0bd74e}
\subsubsection{Question}
\label{sec:org4d27a53}
\begin{quote}
...
\label{sec:org8bb3dbc}
\subsubsection{Text}
\label{sec:org2485f80}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:orgc4d1f70}
\subsubsection{Text}
\label{sec:orgc77bdb0}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org1c0b5ec}
\subsubsection{Question}
\label{sec:orgadd2fbb}
\begin{quote}
...
\subsubsection{Answer}
\label{sec:org1a0ce6e}
\begin{enumerate}
\item Part 1
\label{sec:orge17dfd4}
...
\label{sec:org42c9093}
\subsubsection{Question}
\label{sec:orgce5261d}
\begin{quote}
...
\label{sec:orga9c7696}
\subsubsection{Text}
\label{sec:org94cfbd1}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org54c8ba4}
\subsubsection{Question}
\label{sec:orgc507dd6}
\begin{quote}
...
\label{sec:orgdd3948f}
\subsubsection{Question}
\label{sec:org87e1e74}
\begin{quote}
...
\label{sec:orgaf4b85c}
\subsubsection{Question}
\label{sec:org3537458}
\begin{quote}
...
\label{sec:org462df5c}
\subsubsection{Question}
\label{sec:org70b18f9}
\begin{quote}
...
\label{sec:orgff670f0}
\subsubsection{Text}
\label{sec:orgd9e92c0}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (sum term a next b)
  (if (> a b)
      0
...
\label{sec:org4a196d0}
\subsubsection{Question}
\label{sec:orgbec7918}
\begin{quote}
...
\label{sec:org99f0eed}
\subsubsection{Question A.1}
\label{sec:orgdd46540}
\begin{quote}
...
\label{sec:orgb4b1a7e}
\subsubsection{Question A}
\label{sec:org45ce3b8}
\begin{quote}
...
\label{sec:org326a32c}
\subsubsection{Question A}
\label{sec:orgc5c7164}
\index{filter}
\begin{quote}
...
\label{sec:orgcecbccc}
\subsubsection{Question}
\label{sec:org86e7ebe}
\begin{quote}
...
\label{sec:orgea00178}
\subsubsection{Text}
\label{sec:org1c833fb}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org746641a}
\subsubsection{Question}
\label{sec:org6647a7d}
\begin{quote}
...
\label{sec:org6abaee6}
\subsubsection{Question A}
\label{sec:orgb4b9104}
\begin{quote}
...
\label{sec:org07edd99}
\subsubsection{Question}
\label{sec:org7fc0004}
\begin{quote}
...
\label{sec:orgaf79f9a}
\subsubsection{Question}
\label{sec:orgbdbb274}
\begin{quote}
...
\label{sec:org397056b}
\subsubsection{Text}
\label{sec:org4bcb73e}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgeba3663}
\subsubsection{Question}
\label{sec:org3c83487}
\begin{quote}
...
\label{sec:org0d16956}
\subsubsection{Question}
\label{sec:org9133091}
\begin{quote}
...
\label{sec:orgf66ce9f}
\subsubsection{Question}
\label{sec:orgf1fc68d}
\begin{quote}
...
\label{sec:orgf7ed81c}
\subsubsection{Question}
\label{sec:orgb4c0cc9}
\index{smoothing}
\begin{quote}
...
\label{sec:org62ba78f}
\subsubsection{Question}
\label{sec:org94d05f7}
\begin{quote}
...
\label{sec:orgfe02ae1}
\subsubsection{Question}
\label{sec:org5b46d94}
\begin{quote}
...
\label{sec:orga1b5e8c}
\subsubsection{Text}
\label{sec:orga8c4775}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (add-rat x y)
...
\label{sec:orgf6e6bf4}
\subsubsection{Question}
\label{sec:orgef1c60e}
...
\label{sec:org21625eb}
\subsubsection{Question}
\label{sec:orgcf81533}
...
\(\mathrm{B}\). by experimentation I've figured out that \(\mathrm{A} +
(\mathrm{C}-\mathrm{B}\).
