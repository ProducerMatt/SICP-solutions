...
\label{sec:org1e62e9e}
\subsection{Text Foreword}
\label{sec:org97bc2f2}
...
\label{sec:org41001ff}
\subsubsection{Question}
\label{sec:org21464eb}
\begin{quote}
...
\label{sec:orgfb287ab}
\subsubsection{Question}
\label{sec:org1e109d3}
\begin{quote}
...
\label{sec:org12a4439}
\subsubsection{Question}
\label{sec:orgb5ef5f0}
\begin{quote}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\end{quote}
\subsubsection{Answer}
\label{sec:orga08c8e2}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orgec2fb9c}
\subsubsection{Question}
\label{sec:org709f1b4}
\begin{quote}
...
\label{sec:orgae718a7}
\subsubsection{Question}
\label{sec:org72830bc}
\begin{quote}
...
\label{sec:org2232800}
\subsubsection{Text}
\label{sec:org0c5f0a5}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsubsection{Question}
\label{sec:orga6a0bed}
\begin{quote}
...
\end{quote}
\subsubsection{Diary}
\label{sec:org9868e09}
\begin{enumerate}
\item Solving
\label{sec:orgfa7c6da}
...
\label{sec:org6ef1eda}
\begin{enumerate}
\item Non-optimized
\label{sec:orgcf01a41}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org424891d}
\subsubsection{Question}
\label{sec:org3903e0b}
\begin{quote}
...
\label{sec:org659e2ba}
\subsubsection{Question}
\label{sec:org0f2de1f}
\begin{quote}
...
\label{sec:org7e0b3f7}
\subsubsection{Question}
\label{sec:org379923b}
\begin{quote}
...
\subsubsection{Answer}
\label{sec:orgf379001}
\begin{enumerate}
\item \texttt{f}
\label{sec:org8bd6793}
...
\end{quote}
\subsubsection{Answer}
\label{sec:org3b2faf5}
\begin{enumerate}
\item Recursive
\label{sec:orga696e2c}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\label{sec:orgf8ce5d0}
\subsubsection{Question}
\label{sec:orgcce8678}
\begin{quote}
...
\label{sec:org30db201}
\subsubsection{Question}
\label{sec:org6f50ad9}
\begin{quote}
...
\label{sec:org82d18a0}
\subsubsection{Question A}
\label{sec:org439be72}
\begin{quote}
...
\label{sec:org2f4d55e}
\subsubsection{Text}
\label{sec:org314b50d}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org292d815}
\subsubsection{Question}
\label{sec:org2f319e0}
\begin{quote}
...
\label{sec:org04ae9c1}
\subsubsection{Question}
\label{sec:org034a00a}
\begin{quote}
Using the results of \hyperref[sec:org2f4d55e]{Exercise 1.16} and \hyperref[sec:org292d815]{Exercise 1.17}, devise a procedure that
...
\end{quote}
\subsubsection{Diary}
\label{sec:org8d106ef}
\begin{enumerate}
\item Comparison benchmarks:
\label{sec:org684cb0f}
...
\label{sec:orgbfceee8}
\subsubsection{Question}
\label{sec:org84f99ce}
\begin{quote}
...
\label{sec:org579b27f}
\subsubsection{Text}
\label{sec:org5800ef3}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org6191868}
\subsubsection{Text}
\label{sec:org74baf62}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org0359504}
\subsubsection{Question}
\label{sec:orge6f81d6}
\begin{quote}
...
\subsubsection{Answer}
\label{sec:orge424f4d}
\begin{enumerate}
\item Part 1
\label{sec:orgc25fb3a}
...
\label{sec:orgb5d80e9}
\subsubsection{Question}
\label{sec:org70975cc}
\begin{quote}
...
\label{sec:org6163e8b}
\subsubsection{Text}
\label{sec:org7fc96e7}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org7f10ea6}
\subsubsection{Text}
\label{sec:org89cbcdd}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (sum term a next b)
  (if (> a b)
      0
...
\label{sec:org68b44dd}
\subsubsection{Question}
\label{sec:orgee391ef}
\begin{quote}
...
\label{sec:org3c709f0}
\subsubsection{Question A.1}
\label{sec:org2ca8ac0}
\begin{quote}
...
\label{sec:orga2df476}
\subsubsection{Question A}
\label{sec:orgf55c0cb}
\begin{quote}
...
\label{sec:org100076a}
\subsubsection{Question A}
\label{sec:org3d304c4}
\index{filter}
\begin{quote}
...
\label{sec:orgf6a2d17}
\subsubsection{Question}
\label{sec:org328097b}
\begin{quote}
...
\label{sec:org4f92689}
\subsubsection{Text}
\label{sec:org4affbd8}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgaa0fcfb}
\subsubsection{Question}
\label{sec:org35b81d4}
\begin{quote}
...
\label{sec:org4c218ff}
\subsubsection{Question A}
\label{sec:org88eb4c0}
\begin{quote}
...
\label{sec:org7b64787}
\subsubsection{Question}
\label{sec:orgc826b4c}
\begin{quote}
...
\label{sec:org85bcfb0}
\subsubsection{Question}
\label{sec:orgf48ad83}
\begin{quote}
...
\label{sec:orgb913af2}
\subsubsection{Text}
\label{sec:orgaf658a5}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org331f0a3}
\subsubsection{Question}
\label{sec:org20fd7be}
\begin{quote}
...
\label{sec:org98c6742}
\subsubsection{Question}
\label{sec:orgccb12e4}
\begin{quote}
...
\label{sec:org8b455c9}
\subsubsection{Question}
\label{sec:orge18546c}
\begin{quote}
...
\label{sec:org97f110b}
\subsubsection{Question}
\label{sec:org168e5af}
\index{smoothing}
\begin{quote}
...
\label{sec:org256f10e}
\subsubsection{Question}
\label{sec:org5d44672}
\begin{quote}
...
\label{sec:org27ffd02}
\subsubsection{Question}
\label{sec:org3680368}
\begin{quote}
