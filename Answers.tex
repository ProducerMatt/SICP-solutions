...
\label{sec:orge6941eb}
\subsection{Text Foreword}
\label{sec:org621b153}
...
\label{sec:orgc7ddb30}
\subsubsection{Question}
\label{sec:orgd09cc4f}
\begin{quote}
...
\label{sec:org8b36998}
\subsubsection{Question}
\label{sec:orgfb0bece}
\begin{quote}
...
\label{sec:orgcb9f1fd}
\subsubsection{Question}
\label{sec:orgd2702e7}
\begin{quote}
Define a procedure that takes three numbers as arguments and returns the sum of
the squares of the two larger numbers.
\end{quote}
\subsubsection{Answer}
\label{sec:org417108f}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org40d7ef0}
\subsubsection{Question}
\label{sec:orga024a34}
\begin{quote}
...
\label{sec:orgc01c7d5}
\subsubsection{Question}
\label{sec:orgb275a62}
\begin{quote}
...
\label{sec:org108ee32}
\subsubsection{Text code}
\label{sec:orge4e9bee}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (abs x)
  (if (< x 0)
      (- x)
...
\label{sec:org93882bc}
\subsubsection{Text}
\label{sec:org7a984a2}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (mean-square x y)
  (average (square x) (square y)))
\end{minted}
\subsubsection{Question}
\label{sec:org573fcc9}
\begin{quote}
...
\end{quote}
\subsubsection{Diary}
\label{sec:org16a3404}
\begin{enumerate}
\item Solving
\label{sec:org8ad37d9}
...
\label{sec:org8f440f2}
\begin{enumerate}
\item Non-optimized
\label{sec:orgba59de5}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org12e266d}
\subsubsection{Question}
\label{sec:org967fd0e}
\begin{quote}
...
\label{sec:orgafb4c4e}
\subsubsection{Question}
\label{sec:org487b61a}
\begin{quote}
...
\label{sec:org9c92f80}
\subsubsection{Question}
\label{sec:orgcc85928}
\begin{quote}
...
\subsubsection{Answer}
\label{sec:orgc20a99d}
\begin{enumerate}
\item \texttt{f}
\label{sec:orge1ad289}
...
\end{quote}
\subsubsection{Answer}
\label{sec:org91e52d1}
\begin{enumerate}
\item Recursive
\label{sec:org95a8ec1}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (fr n)
  (if (< n 3)
      n
...
\item Iterative
\label{sec:org1db8194}
\begin{enumerate}
\item Attempt 1
\label{sec:org6c42f52}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgd27d204}
\subsubsection{Question}
\label{sec:org3fb26ed}
\begin{quote}
...
\label{sec:orgc1c77da}
\subsubsection{Question}
\label{sec:org85c43ae}
\begin{quote}
...
\label{sec:org606a3f5}
\subsubsection{Question A}
\label{sec:org1ed2581}
\begin{quote}
...
\label{sec:org8190a08}
\subsubsection{Text}
\label{sec:orgf428320}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (expt-rec b n)
  (if (= n 0) 
      1 
...
\label{sec:org83e6914}
\subsubsection{Question}
\label{sec:org3c26ff6}
\begin{quote}
...
\label{sec:org48da2e5}
\subsubsection{Question}
\label{sec:org9ce0956}
\begin{quote}
Using the results of \hyperref[sec:org8190a08]{Exercise 1.16} and \hyperref[sec:org83e6914]{Exercise 1.17}, devise a procedure that
...
\end{quote}
\subsubsection{Diary}
\label{sec:orgc0dac53}
\begin{enumerate}
\item Comparison benchmarks:
\label{sec:org6495eb4}
...
\label{sec:orgae9489d}
\subsubsection{Question}
\label{sec:org70894c6}
\begin{quote}
...
\label{sec:org5390617}
\subsubsection{Text}
\label{sec:org4ba4a38}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (gcd a b)
  (if (= b 0)
      a
...
\label{sec:org5695f3f}
\subsubsection{Text}
\label{sec:orgbfae813}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:org713afb9}
\subsubsection{Question}
\label{sec:org3679769}
\begin{quote}
...
\subsubsection{Answer}
\label{sec:orgbea173e}
\begin{enumerate}
\item Part 1
\label{sec:orgd416406}
...
\label{sec:org2c1b185}
\subsubsection{Question}
\label{sec:org1f8d137}
\begin{quote}
...
\label{sec:org4e17820}
\subsubsection{Text}
\label{sec:org1fc6fc4}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
<<square>>
...
\label{sec:orga6471eb}
\subsubsection{Question}
\label{sec:orgb9a92ad}
\begin{quote}
...
\label{sec:orga4902ee}
\subsubsection{Question}
\label{sec:orgd660b16}
\begin{quote}
...
\label{sec:org4f29129}
\subsubsection{Question}
\label{sec:org3a5f631}
\begin{quote}
...
\label{sec:org45c962b}
\subsubsection{Question}
\label{sec:orgb3425c9}
\begin{quote}
...
\label{sec:org5650a87}
\subsubsection{Text}
\label{sec:orgead8376}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (sum term a next b)
  (if (> a b)
      0
...
\label{sec:org2d6d669}
\subsubsection{Question}
\label{sec:orgf5f9374}
\begin{quote}
...
\label{sec:org3aa9511}
\subsubsection{Question A.1}
\label{sec:orgca41b15}
\begin{quote}
...
\label{sec:orgaf66f0d}
\subsubsection{Question A}
\label{sec:org1c5c82c}
\begin{quote}
...
\label{sec:orgce86573}
\subsubsection{Question A}
\label{sec:org9c5be28}
\index{filter}
\begin{quote}
...
\label{sec:org899d287}
\subsubsection{Question}
\label{sec:orgb353c64}
\begin{quote}
...
\label{sec:orgad90f18}
\subsubsection{Text}
\label{sec:orge0e6bbb}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:org1272b18}
\subsubsection{Question}
\label{sec:org1a873ac}
\begin{quote}
...
\label{sec:org619a065}
\subsubsection{Question A}
\label{sec:org5d9323c}
\begin{quote}
...
\label{sec:org52a7aac}
\subsubsection{Question}
\label{sec:org546bc5a}
\begin{quote}
...
\label{sec:orgcb03824}
\subsubsection{Question}
\label{sec:orgdb8a126}
\begin{quote}
...
\label{sec:org5640d18}
\subsubsection{Text}
\label{sec:org2e67554}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
...
\label{sec:orgef2ffd2}
\subsubsection{Question}
\label{sec:org4e5cd4d}
\begin{quote}
...
\label{sec:orgd0ac123}
\subsubsection{Question}
\label{sec:org6ccf08a}
\begin{quote}
...
\label{sec:org8f4aca9}
\subsubsection{Question}
\label{sec:orgc82d5f8}
\begin{quote}
...
\label{sec:orgedd0268}
\subsubsection{Question}
\label{sec:org749ce3c}
\index{smoothing}
\begin{quote}
...
\label{sec:orgc9b391d}
\subsubsection{Question}
\label{sec:org1dabde6}
\begin{quote}
...
\label{sec:org2c263fe}
\subsubsection{Question}
\label{sec:org0327888}
\begin{quote}
...
\label{sec:orgae7a79d}
\subsubsection{Text}
\label{sec:orgc09e8fa}
\begin{minted}[breaklines=true,breakanywhere=true,linenos=true]{scheme}
(define (add-rat x y)
...
\label{sec:org4c14961}
\subsubsection{Question}
\label{sec:org7144fdd}
...
\label{sec:org34abaf5}
\subsubsection{Question}
\label{sec:orgdf7e61c}
